...
{
    public partial class BOSRichEditControl : RichEditControl, IBOSControl
    {
        #region Variables
        ...
        #region Constructor
        public BOSRichEditControl()
        {
            InitializeComponent();
        }

        public BOSRichEditControl(IContainer container)
        {
            container.Add(this);
        ...
        public void InitializeControl(STFieldsInfo objFieldInfo)
        {
            ...
            this.ReadOnly = objFieldInfo.STFieldReadOnly;
