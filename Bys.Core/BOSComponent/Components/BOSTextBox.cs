...
namespace BOSComponent
{
    public partial class BOSTextBox : DevExpress.XtraEditors.TextEdit, IBOSControl
    {
        ...
        public void InitializeControl()
        {
            ...
            this.Spin += new DevExpress.XtraEditors.Controls.SpinEventHandler(BOSTextBox_Spin);
        }

        void BOSTextBox_Spin(object sender, DevExpress.XtraEditors.Controls.SpinEventArgs e)
        {
            e.Handled = true;
        }
        #endregion
