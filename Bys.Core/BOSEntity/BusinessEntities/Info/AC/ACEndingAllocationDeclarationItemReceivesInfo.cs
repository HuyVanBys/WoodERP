...
namespace BOSERP
{
    ...
    //Class:ACEndingAllocationDeclarationItemReceivesInfo
    //Created Date:Wednesday, November 14, 2018
    //-----------------------------------------------------------

    public class ACEndingAllocationDeclarationItemReceivesInfo : BusinessObject
    {
        public ACEndingAllocationDeclarationItemReceivesInfo()
        {
        }
        #region Variables
        protected int _aCEndingAllocationDeclarationItemReceiveID;
        ...
        protected decimal _aCEndingAllocationDeclarationItemReceiveFactor;
        ...
        public int ACEndingAllocationDeclarationItemReceiveID
        {
            get { return _aCEndingAllocationDeclarationItemReceiveID; }
            set
            {
                if (value != this._aCEndingAllocationDeclarationItemReceiveID)
                {
                    _aCEndingAllocationDeclarationItemReceiveID = value;
                    NotifyChanged("ACEndingAllocationDeclarationItemReceiveID");
                }
            }
        }
        ...
        public decimal ACEndingAllocationDeclarationItemReceiveFactor
        {
            get { return _aCEndingAllocationDeclarationItemReceiveFactor; }
            set
            {
                if (value != this._aCEndingAllocationDeclarationItemReceiveFactor)
                {
                    _aCEndingAllocationDeclarationItemReceiveFactor = value;
                    NotifyChanged("ACEndingAllocationDeclarationItemReceiveFactor");
                }
            }
        }
