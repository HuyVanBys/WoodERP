...
namespace BOSERP
{
    ...
    public class HRTimeSheetEntrysInfo : BusinessObject
    {
        ...
        protected decimal _hRTimeSheetEntryWorkingQty;
        protected decimal _hRTimeSheetEntryFactor;
        protected decimal _hRTimeSheetEntryHolidayWorkingHours;
        protected decimal _hRTimeSheetEntryPermissionOTDaysOff;
        ...
        public decimal HRTimeSheetEntryHolidayWorkingHours
        {
            get { return _hRTimeSheetEntryHolidayWorkingHours; }
            set
            {
                if (value != this._hRTimeSheetEntryHolidayWorkingHours)
                {
                    _hRTimeSheetEntryHolidayWorkingHours = value;
                    NotifyChanged("HRTimeSheetEntryHolidayWorkingHours");
                }
            }
        }
        public decimal HRTimeSheetEntryPermissionOTDaysOff
        {
            get { return _hRTimeSheetEntryPermissionOTDaysOff; }
            set
            {
                if (value != this._hRTimeSheetEntryPermissionOTDaysOff)
                {
                    _hRTimeSheetEntryPermissionOTDaysOff = value;
                    NotifyChanged("HRTimeSheetEntryPermissionOTDaysOff");
                }
            }
        }
