...
namespace BOSERP
{
    ...
    public class HRTimesheetEmployeeLatesInfo : BusinessObject
    {
        ...
        protected decimal _hRTimesheetEmployeeLateOTDefault;
        protected String _hRTimesheetEmployeeLateType = String.Empty;
        ...
        public decimal HRTimesheetEmployeeLateOTDefault
        {
            get { return _hRTimesheetEmployeeLateOTDefault; }
            set
            {
                if (value != this._hRTimesheetEmployeeLateOTDefault)
                {
                    _hRTimesheetEmployeeLateOTDefault = value;
                    NotifyChanged("HRTimesheetEmployeeLateOTDefault");
                }
            }
        }
        public String HRTimesheetEmployeeLateType
        {
            get { return _hRTimesheetEmployeeLateType; }
            set
            {
                if (value != this._hRTimesheetEmployeeLateType)
                {
                    _hRTimesheetEmployeeLateType = value;
                    NotifyChanged("HRTimesheetEmployeeLateType");
                }
            }
        }
