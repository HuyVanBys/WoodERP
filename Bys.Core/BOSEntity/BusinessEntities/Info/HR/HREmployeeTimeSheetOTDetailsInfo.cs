...
namespace BOSERP
{
    ...
    public class HREmployeeTimeSheetOTDetailsInfo : BusinessObject
    {
        ...
        protected DateTime _hREmployeeTimeSheetOTDetailEntryDate = DateTime.MaxValue;
        #endregion
        ...
        public DateTime HREmployeeTimeSheetOTDetailEntryDate
        {
            get { return _hREmployeeTimeSheetOTDetailEntryDate; }
            set
            {
                if (value != this._hREmployeeTimeSheetOTDetailEntryDate)
                {
                    _hREmployeeTimeSheetOTDetailEntryDate = value;
                    NotifyChanged("HREmployeeTimeSheetOTDetailEntryDate");
                }
            }
        }
        #endregion
        ...
        public decimal HRTimeSheetParamHours { get; set; }
        public int HRTimeSheetParamHuman { get; set; }
        public decimal HRTimeSheetParamOTFactor { get; set; }
        #endregion
    }
    #endregion
}