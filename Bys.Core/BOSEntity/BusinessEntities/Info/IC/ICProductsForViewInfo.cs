...
namespace BOSERP
{
    public class ICProductsForViewInfo : BusinessObject
    {
        public ICProductsForViewInfo()
        {
        ...
        protected bool _iCProductIsMigrationVAT = true;
        ...
        //    }
        //}
        public bool ICProductIsMigrationVAT
        {
            get { return _iCProductIsMigrationVAT; }
            set
            {
                if (value != this._iCProductIsMigrationVAT)
                {
                    _iCProductIsMigrationVAT = value;
                    NotifyChanged("ICProductIsMigrationVAT");
                }
            }
        }
