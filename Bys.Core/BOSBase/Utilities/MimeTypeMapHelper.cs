...
namespace MimeTypes
{
    public static class MimeTypeMap
    {
        ...
        private static IDictionary<string, string> BuildMappings = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            {".323", "text/h323"},
                {".3g2", "video/3gpp2"},
                {".3gp", "video/3gpp"},
        ...
        public static string GetMimeType(string extension)
        {
            ...
            return BuildMappings.TryGetValue(extension, out mime) ? mime : "application/octet-stream";
        }
    }
}