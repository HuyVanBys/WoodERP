...
(   0,    -- AANumberInt - int
    ...
    'MMHardwareOperationType',   -- AAColumnAliasName - varchar(255)
    N'Công thức tính số lượng',  -- AAColumnAliasCaption - nvarchar(255)
    'MMProductionNormItems',   -- AATableName - varchar(50)
