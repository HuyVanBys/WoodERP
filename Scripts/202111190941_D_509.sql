...
(   0,    -- AANumberInt - int
    ...
    'ACAllocationCostObjectTranModuleDescription',   -- AAColumnAliasName - varchar(255)
    N'Tên module (Mô tả)',  -- AAColumnAliasCaption - nvarchar(255)
    'ACAllocationCostObjectTrans',   -- AATableName - varchar(50)
