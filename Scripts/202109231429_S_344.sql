...
BEGIN
	...
	SELECT (dpi.ARDeliveryPlanItemProductQty - ISNULL(cancel.CanceledDeliveryPlanItemQty,0) + ISNULL(dt.ICReceiptItemProductQty, 0)) AS ARDeliveryPlanItemProductQty
		...
		,  (dpi.ARDeliveryPlanItemProductQty - ISNULL(cancel.CanceledDeliveryPlanItemQty,0) + ISNULL(dt.ICReceiptItemProductQty, 0)) - ISNULL(ship.ShipmentItemProductQty, 0)  AS ARDeliveryPlanItemRemainedQty
		,   dpi.*
