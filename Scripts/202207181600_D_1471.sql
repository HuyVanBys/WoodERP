...
(   'Alive',   -- AAStatus - varchar(50)
    ...
    (SELECT MAX(STToolbarOrder) + 1 FROM  dbo.STToolbars WHERE AAStatus = 'Alive' AND STModuleID = (SELECT STModuleID FROM  dbo.STModules WHERE STModuleName = 'SaleReturn' AND STToolbarGroup = 'Utility')),    -- STToolbarOrder - int
...
(   '', -- STToolbarFunctionIDString - varchar(50)
    (SELECT STToolbarID FROM dbo.STToolbars WHERE STModuleID = (SELECT STModuleID FROM  dbo.STModules WHERE STModuleName = 'SaleReturn') AND STToolbarName = 'fld_barbtnExportTemplate'),  -- STToolbarID - int
