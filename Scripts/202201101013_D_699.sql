...
WHERE STModuleID =  (SELECT STModuleID FROM dbo.STModules WHERE STModuleName = 'ListAccountBank')
AND STToolbarTag IN ('CancelComplete', 'Delete')

INSERT INTO dbo.STToolbars
VALUES
(   'Alive',   -- AAStatus - varchar(50)
    (SELECT STModuleID FROM dbo.STModules WHERE STModuleName = 'ListAccountBank'),    -- STModuleID - int
    1,    -- STUserGroupID - int
