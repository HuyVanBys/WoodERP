...
namespace BOSERP.Modules.PositionWire
{
    public class PositionWireEntities : ERPModuleEntities
    {
        ...
        public override void SetDefaultMainObject()
        {
            ...
            objPositionsInfo.MMPositionType = PositionType.Wire.ToString();
        }
