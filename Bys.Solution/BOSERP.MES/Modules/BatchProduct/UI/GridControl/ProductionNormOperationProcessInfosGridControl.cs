...
namespace BOSERP
{
    public partial class ProductionNormOperationProcessInfosGridControl : BOSGridControl
    {
        /// <summary>
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Delete)
            {
                ...
                if (gridView.FocusedRowHandle >= 0)
                {
                    ...
                    ((guiProductionNormOperationProcessInfos)Screen).RemoveProductionNormProcessInfo(index);
                }
            }
        }
        protected override GridView InitializeGridView()
        {
            ...
            foreach (DevExpress.XtraGrid.Columns.GridColumn columns in gridView.Columns)
            {
                ...
                if (columns.FieldName == "FK_MMOperationID")
                {
        ...
        void repositoryItemWoodLookUpEdit_QueryPopUp(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            List<ICProductsForViewInfo> productList = BOSApp.CurrentProductList.Where(x => x.ICProductType == ProductType.MMTB.ToString()).ToList();
