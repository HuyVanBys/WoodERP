...
{
    public class MMBPNormItemInstrumentsGridControl : BOSGridControl
    {
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.BPProductionNormItemInstrumentList;
            this.DataSource = bds;
        }
        ...
        protected override void GridView_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            if (e.Column.FieldName == "MMAllocationPlanItemQty")
            {
                ...
                ((BatchProductSheduleModule)Screen.Module).ChangeItemQty(entity.BPProductionNormItemInstrumentList, item, oldItemQty);
            }
        }
        ...
        public void Alternative_Click(object sender, EventArgs e)
        {
            ...
            if (item != null)
                ((BatchProductSheduleModule)Screen.Module).AlternativeItems(entity.BPProductionNormItemInstrumentList, item, false, false);
        }
        public void CancelAlternative_Click(object sender, EventArgs e)
        {
            ...
            {
                ((BatchProductSheduleModule)Screen.Module).CancelAlternativeItems(entity.BPProductionNormItemInstrumentList, item, false);
            }
        }
        public void ApproveItemInGroupAllocation_Click(object sender, EventArgs e)
        {
            ...
            ((BatchProductSheduleModule)Screen.Module).ApproveGroupItems(entity.BPProductionNormItemInstrumentList, AllocationPlanItemGroup.GeneralMaterial.ToString(), materialList);
        }
        public void PlanItemInGroupAllocation_Click(object sender, EventArgs e)
        {
            ...
            RowInfo info = menuItem.Tag as RowInfo;
            List<MMAllocationPlanItemsInfo> materialList = SelectGroupRows(info.RowHandle);
            ((BatchProductSheduleModule)Screen.Module).PlanGroupItems(entity.BPProductionNormItemInstrumentList, AllocationPlanItemGroup.GeneralMaterial.ToString(), materialList);
        }
        ...
        public void AllocationQty_Click(object sender, EventArgs e)
        {
            ...
            BatchProductSheduleEntities entity = (BatchProductSheduleEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            ((BatchProductSheduleModule)Screen.Module).AllocationQty(entity.BPProductionNormItemInstrumentList, guiFind.AllocationQty, guiFind.IsRate, guiFind.RoundNum);
        }
        ...
        public void MergeItemSameGroup_Click(object sender, EventArgs e)
        {
            ...
            GridView gridView = (GridView)MainView;
            RowInfo info = menuItem.Tag as RowInfo;
            ((BatchProductSheduleModule)Screen.Module).MergeSameGroupItems(entity.BPProductionNormItemInstrumentList);
        }
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                BatchProductSheduleEntities entity = (BatchProductSheduleEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
                ((BatchProductSheduleModule)Screen.Module).RemoveItemFromList(entity.BPProductionNormItemInstrumentList, AllocationPlanItemGroup.GeneralMaterial.ToString());
            }
        }
    }
}
