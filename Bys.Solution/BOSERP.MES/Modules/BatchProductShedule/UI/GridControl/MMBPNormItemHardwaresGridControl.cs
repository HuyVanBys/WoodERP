...
{
    public class MMBPNormItemHardwaresGridControl : BOSGridControl
    {
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.BPProductionNormItemHardwareList;
            this.DataSource = bds;
        }
        ...
        protected override void GridView_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            if (e.Column.FieldName == "MMAllocationPlanItemQty")
            {
                ...
                ((BatchProductSheduleModule)Screen.Module).ChangeItemQty(entity.BPProductionNormItemHardwareList, item, oldItemQty);
            }
        }
        ...
        public void ApproveItemInGroupAllocation_Click(object sender, EventArgs e)
        {
            ...
            ((BatchProductSheduleModule)Screen.Module).ApproveGroupItems(entity.BPProductionNormItemHardwareList, AllocationPlanItemGroup.Hardware.ToString(), materialList);
        }
        public void PlanItemInGroupAllocation_Click(object sender, EventArgs e)
        {
            ...
            RowInfo info = menuItem.Tag as RowInfo;
            List<MMAllocationPlanItemsInfo> materialList = SelectGroupRows(info.RowHandle);
            ((BatchProductSheduleModule)Screen.Module).PlanGroupItems(entity.BPProductionNormItemHardwareList, AllocationPlanItemGroup.Hardware.ToString(), materialList);
        }
        ...
        public void MergeItemSameGroup_Click(object sender, EventArgs e)
        {
            ...
            GridView gridView = (GridView)MainView;
            RowInfo info = menuItem.Tag as RowInfo;
            ((BatchProductSheduleModule)Screen.Module).MergeSameGroupItems(entity.BPProductionNormItemHardwareList);
        }
        public void Alternative_Click(object sender, EventArgs e)
        {
            ...
            RowInfo info = menuItem.Tag as RowInfo;
            MMAllocationPlanItemsInfo item = (MMAllocationPlanItemsInfo)gridView.GetRow(info.RowHandle);
            ((BatchProductSheduleModule)Screen.Module).AlternativeItems(entity.BPProductionNormItemHardwareList, item, false, false);
        ...
        public void CancelAlternative_Click(object sender, EventArgs e)
        {
            ...
            {
                ((BatchProductSheduleModule)Screen.Module).CancelAlternativeItems(entity.BPProductionNormItemHardwareList, item, false);
            }
        }
        ...
        public void AllocationQty_Click(object sender, EventArgs e)
        {
            ...
            BatchProductSheduleEntities entity = (BatchProductSheduleEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            ((BatchProductSheduleModule)Screen.Module).AllocationQty(entity.BPProductionNormItemHardwareList, guiFind.AllocationQty, guiFind.IsRate, guiFind.RoundNum);
        }
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                BatchProductSheduleEntities entity = (BatchProductSheduleEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
                ((BatchProductSheduleModule)Screen.Module).RemoveItemFromList(entity.BPProductionNormItemHardwareList, AllocationPlanItemGroup.Hardware.ToString());
            }
        }
    }
}
