...
{
    public class MMBPNormItemPackagingsGridControl : BOSGridControl
    {
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.BPProductionNormItemPackagingList;
            this.DataSource = bds;
        }
        ...
        protected override void AddColumnsFromColumnAlias(string strTableName, GridView gridView, List<AAColumnAliasInfo> lstColumnAlias)
        {
            ...
            AddGridColumn(strTableName, "MMBPSemiProductNo", "Thuộc chi tiết");
            ...
            AddGridColumn(strTableName, "MMAllocationPlanItemBPQty", "SL ĐM");
            AddGridColumn(strTableName, "MMAllocationPlanItemQty", "SL kế hoạch");
            //AddGridColumn(strTableName, "MMAllocationPlanItemRemainQty", "SL còn lại");
        ...
        protected override void GridView_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            if (e.Column.FieldName == "MMAllocationPlanItemQty")
            {
                ...
                ((BatchProductSheduleModule)Screen.Module).ChangeItemQty(entity.BPProductionNormItemPackagingList, item, oldItemQty);
            }
        }
        ...
        {
            GridView gridView = (GridView)MainView;
            MMAllocationPlanItemsInfo objBatchProductProductionNormItemsInfo = (MMAllocationPlanItemsInfo)gridView.GetRow(e.ListSourceRowIndex);
        ...
        public void Alternative_Click(object sender, EventArgs e)
        {
            ...
            if (item != null)
                ((BatchProductSheduleModule)Screen.Module).AlternativeItems(entity.BPProductionNormItemPackagingList, item, false, false);
        }
        public void CancelAlternative_Click(object sender, EventArgs e)
        {
            ...
            {
                ((BatchProductSheduleModule)Screen.Module).CancelAlternativeItems(entity.BPProductionNormItemPackagingList, item, false);
            }
        }
        public void ApproveItemInGroupAllocation_Click(object sender, EventArgs e)
        {
            ...
            ((BatchProductSheduleModule)Screen.Module).ApproveGroupItems(entity.BPProductionNormItemPackagingList, AllocationPlanItemGroup.IngredientPackaging.ToString(), materialList);
        }
        public void PlanItemInGroupAllocation_Click(object sender, EventArgs e)
        {
            ...
            RowInfo info = menuItem.Tag as RowInfo;
            List<MMAllocationPlanItemsInfo> materialList = SelectGroupRows(info.RowHandle);
            ((BatchProductSheduleModule)Screen.Module).PlanGroupItems(entity.BPProductionNormItemPackagingList, AllocationPlanItemGroup.IngredientPackaging.ToString(), materialList);
        }
        ...
        public void AllocationQty_Click(object sender, EventArgs e)
        {
            ...
            BatchProductSheduleEntities entity = (BatchProductSheduleEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            ((BatchProductSheduleModule)Screen.Module).AllocationQty(entity.BPProductionNormItemPackagingList, guiFind.AllocationQty, guiFind.IsRate, guiFind.RoundNum);
        }
        ...
        public void MergeItemSameGroup_Click(object sender, EventArgs e)
        {
            ...
            GridView gridView = (GridView)MainView;
            RowInfo info = menuItem.Tag as RowInfo;
            ((BatchProductSheduleModule)Screen.Module).MergeSameGroupItems(entity.BPProductionNormItemPackagingList);
        }
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                BatchProductSheduleEntities entity = (BatchProductSheduleEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
                ((BatchProductSheduleModule)Screen.Module).RemoveItemFromList(entity.BPProductionNormItemPackagingList, AllocationPlanItemGroup.IngredientPackaging.ToString());
            }
        }
    }
}
