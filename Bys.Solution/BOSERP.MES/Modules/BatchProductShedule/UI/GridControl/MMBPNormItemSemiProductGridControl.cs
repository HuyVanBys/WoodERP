...
{
    public class MMBPNormItemSemiProductGridControl : BOSGridControl
    {
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.BPProductionNormItemSemiProductList;
            this.DataSource = bds;
        }
        ...
        protected override void AddColumnsFromColumnAlias(string strTableName, GridView gridView, List<AAColumnAliasInfo> lstColumnAlias)
        {
            ...
            AddGridColumn(strTableName, "MMAllocationPlanItemProductName", "Tên chi tiết");
            AddGridColumn(strTableName, "MMAllocationPlanItemProductDesc", "Mô tả chi tết");
            ...
            AddGridColumn(strTableName, "ICProductNoOfOldSys", "Mã HT cũ");
        ...
        protected override void GridView_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            if (e.Column.FieldName == "MMAllocationPlanItemQty")
            {
                ...
                ((BatchProductSheduleModule)Screen.Module).ChangeItemQty(entity.BPProductionNormItemSemiProductList, item, oldItemQty);
            }
        }
        ...
        public void ApproveItemInGroupAllocation_Click(object sender, EventArgs e)
        {
            ...
            ((BatchProductSheduleModule)Screen.Module).ApproveGroupItems(entity.BPProductionNormItemSemiProductList, AllocationPlanItemGroup.SemiProduct.ToString(), materialList);
        }
        public void PlanItemInGroupAllocation_Click(object sender, EventArgs e)
        {
            ...
            RowInfo info = menuItem.Tag as RowInfo;
            List<MMAllocationPlanItemsInfo> materialList = SelectGroupRows(info.RowHandle);
            ((BatchProductSheduleModule)Screen.Module).PlanGroupItems(entity.BPProductionNormItemSemiProductList, AllocationPlanItemGroup.SemiProduct.ToString(), materialList);
        }
        ...
        public void MergeItemSameGroup_Click(object sender, EventArgs e)
        {
            ...
            GridView gridView = (GridView)MainView;
            RowInfo info = menuItem.Tag as RowInfo;
            ((BatchProductSheduleModule)Screen.Module).MergeSameGroupItems(entity.BPProductionNormItemSemiProductList);
        }
        ...
        public void ItemInGroupViewOperationDetailPlan_Click(object sender, EventArgs e)
        {
            ...
            guiShowOperationDetailPlanMaterial guiFind = new guiShowOperationDetailPlanMaterial(item.FK_MMBatchProductID, 0, item.FK_ICProductID, 0, item.MMBatchProductDate);
            guiFind.Module = Screen.Module;
            guiFind.OperationDetailPlanType = ProductType.SemiProduct.ToString();
            guiFind.ShowDialog();
        }
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                BatchProductSheduleEntities entity = (BatchProductSheduleEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
                ((BatchProductSheduleModule)Screen.Module).RemoveItemFromList(entity.BPProductionNormItemSemiProductList, AllocationPlanItemGroup.SemiProduct.ToString());
            }
        }
    }
}
