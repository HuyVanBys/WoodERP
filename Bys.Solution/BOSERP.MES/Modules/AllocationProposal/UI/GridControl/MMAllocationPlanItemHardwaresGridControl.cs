...
{
    public class MMAllocationPlanItemHardwaresGridControl : BOSGridControl
    {
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.AllocationPlanItemHardwareList;
            this.DataSource = bds;
        }
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                AllocationProposalEntities entity = (AllocationProposalEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
                ((AllocationProposalModule)Screen.Module).RemoveItemFromList(entity.AllocationPlanItemHardwareList);
            }
        }
        ...
        protected override GridView InitializeGridView()
        {
            ...
            if (gridColumn != null)
            {
                ...
                repositoryItemLookupEdit.DataSource = BOSApp.CurrentProductList.Where(o => o.ICProductType == ProductType.Hardware.ToString()
        ...
        protected override void GridView_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            {
                ((AllocationProposalModule)Screen.Module).ChangeProduct(entity.AllocationPlanItemHardwareList, item, AllocationPlanItemGroup.Hardware.ToString());
            }
        }
