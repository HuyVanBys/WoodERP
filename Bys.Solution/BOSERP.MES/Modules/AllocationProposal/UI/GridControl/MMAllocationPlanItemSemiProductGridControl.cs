...
{
    public class MMAllocationPlanItemSemiProductGridControl : BOSGridControl
    {
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.AllocationPlanItemSemiProductList;
            this.DataSource = bds;
        }
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                AllocationProposalEntities entity = (AllocationProposalEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
                ((AllocationProposalModule)Screen.Module).RemoveItemFromList(entity.AllocationPlanItemSemiProductList);
            }
        }
        ...
        protected override GridView InitializeGridView()
        {
            ...
            if (gridColumn != null)
            {
                ...
                repositoryItemLookupEdit.DataSource = BOSApp.CurrentProductList.Where(o => o.ICProductType == ProductType.SemiProduct.ToString()).ToList();
        ...
        protected override void GridView_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            {
                ((AllocationProposalModule)Screen.Module).ChangeProduct(entity.AllocationPlanItemSemiProductList, item, AllocationPlanItemGroup.SemiProduct.ToString());
            }
        }
