...
{
    public class MMAllocationPlanItemSteelsGridControl : BOSGridControl
    {
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.AllocationPlanItemOtherMaterialList;
            this.DataSource = bds;
        }
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                AllocationProposalEntities entity = (AllocationProposalEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
                ((AllocationProposalModule)Screen.Module).RemoveItemFromList(entity.AllocationPlanItemOtherMaterialList);
            }
        }
        ...
        protected override void GridView_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            {
                ((AllocationProposalModule)Screen.Module).ChangeProduct(entity.AllocationPlanItemOtherMaterialList, item, AllocationPlanItemGroup.OtherMaterial.ToString());
            }
        }
