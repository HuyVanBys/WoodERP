...
{
    public class MMAllocationPlanItemWoodsGridControl : BOSGridControl
    {
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.AllocationPlanItemMaterialList;
            this.DataSource = bds;
        }
        ...
        protected override void AddColumnsFromColumnAlias(string strTableName, GridView gridView, List<AAColumnAliasInfo> lstColumnAlias)
        {
            ...
            AddGridColumn(strTableName, "MMAllocationPlanItemQty", "Khối lượng");
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                AllocationProposalEntities entity = (AllocationProposalEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
                ((AllocationProposalModule)Screen.Module).RemoveItemFromList(entity.AllocationPlanItemMaterialList);
            }
        }
        ...
        protected override GridView InitializeGridView()
        {
            ...
            if (gridColumn != null)
            {
                ...
                repositoryItemLookupEdit.DataSource = ((AllocationProposalModule)Screen.Module).GetWoodIngredient(MaterialDepartList);
        ...
        protected override void GridView_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            {
                ((AllocationProposalModule)Screen.Module).ChangeProduct(entity.AllocationPlanItemMaterialList, item, AllocationPlanItemGroup.Material.ToString());
            }
        }
