...
{
    public class MMAllocationPlanItemPaintsGridControl : BOSGridControl
    {
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.AllocationPlanItemPaintList;
            this.DataSource = bds;
        }
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                AllocationProposalEntities entity = (AllocationProposalEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
                ((AllocationProposalModule)Screen.Module).RemoveItemFromList(entity.AllocationPlanItemPaintList);
            }
        }
        ...
        protected override GridView InitializeGridView()
        {
            ...
            if (gridColumn != null)
            {
                ...
                repositoryItemLookupEdit.DataSource = BOSApp.CurrentProductList.Where(o => o.ICProductType == ProductType.IngredientPaint.ToString()
        ...
        protected override void GridView_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            {
                ((AllocationProposalModule)Screen.Module).ChangeProduct(entity.AllocationPlanItemPaintList, item, AllocationPlanItemGroup.IngredientPaint.ToString());
            }
        }
