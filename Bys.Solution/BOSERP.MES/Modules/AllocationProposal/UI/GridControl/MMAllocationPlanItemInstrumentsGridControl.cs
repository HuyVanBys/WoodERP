...
{
    public class MMAllocationPlanItemInstrumentsGridControl : BOSGridControl
    {
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.AllocationPlanItemInstrumentList;
            this.DataSource = bds;
        }
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                AllocationProposalEntities entity = (AllocationProposalEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
                ((AllocationProposalModule)Screen.Module).RemoveItemFromList(entity.AllocationPlanItemInstrumentList);
            }
        }
        ...
        protected override void GridView_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            {
                ((AllocationProposalModule)Screen.Module).ChangeProduct(entity.AllocationPlanItemInstrumentList, item, AllocationPlanItemGroup.GeneralMaterial.ToString());
            }
        }
