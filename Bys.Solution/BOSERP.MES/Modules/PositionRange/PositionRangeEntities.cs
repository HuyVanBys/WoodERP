...
namespace BOSERP.Modules.PositionRange
{
    public class PositionRangeEntities : ERPModuleEntities
    {
        ...
        public override void SetDefaultMainObject()
        {
            ...
            objPositionsInfo.MMPositionType = PositionType.Range.ToString();
