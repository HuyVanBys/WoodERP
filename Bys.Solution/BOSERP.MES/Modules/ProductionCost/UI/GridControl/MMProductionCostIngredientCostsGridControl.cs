...
namespace BOSERP.Modules.ProductionCost
{
    public class MMProductionCostIngredientCostsGridControl : BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.ProductionCostIngredientCostListPhoi;
            this.DataSource = bds;
        }
        ...
        protected override DevExpress.XtraGrid.Views.Grid.GridView InitializeGridView()
        {
            ...
            column = gridView.Columns["MMProductionCostIngredientCostBatchProductNo"];
            if (column != null)
            {
                column.Group();
                column.GroupIndex = 0;
            ...
            column = gridView.Columns["MMProductionCostIngredientCostProductWoodQty"];
            if (column != null)
            {
                column.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum;
                column.SummaryItem.DisplayFormat = "{0:N2}";
                ...
                GridGroupSummaryItem summaryItem = new GridGroupSummaryItem();
                summaryItem.FieldName = "MMProductionCostIngredientCostProductWoodQty";
                summaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum;
                summaryItem.DisplayFormat = "{0:N4}";
                summaryItem.ShowInGroupColumnFooter = column;
                gridView.GroupSummary.Add(summaryItem);
