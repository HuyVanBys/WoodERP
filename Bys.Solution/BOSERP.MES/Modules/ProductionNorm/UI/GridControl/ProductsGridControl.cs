...
{
    public partial class ProductsGridControl : BOSGridControl
    {
        ...
        protected override GridView InitializeGridView()
        {
            ...
            if (gridview.Columns["ICProductCode"] != null)
                gridview.Columns["ICProductCode"].OptionsColumn.AllowEdit = true;
            ...
            //    gridview.Columns["FK_ICProductAttributeWoodTypeID"].MinWidth = 150;
            ...
            if (gridview.Columns["HasComponent"] != null)
                gridview.Columns["HasComponent"].OptionsColumn.AllowEdit = true;
        ...
        protected override void AddColumnsToGridView(string strTableName, GridView gridView)
        {
            ...
            repositoryItemLookUpEdit.QueryPopUp += repositoryItemAttributeQualityLookupEdit_QueryPopUp;
            repositoryItemLookUpEdit.ButtonsStyle = BorderStyles.Office2003;
            repositoryItemLookUpEdit.Tag = "WoodType";
            gridView.Columns["FK_ICProductAttributeWoodTypeID"].ColumnEdit = repositoryItemLookUpEdit;
            gridView.Columns["FK_ICProductAttributeWoodTypeID"].MinWidth = 150;
            ...
            repositoryItemLookUpEdit.QueryPopUp += repositoryItemAttributeQualityLookupEdit_QueryPopUp;
            repositoryItemLookUpEdit.ButtonsStyle = BorderStyles.Office2003;
            repositoryItemLookUpEdit.Tag = "Speciality";
            gridView.Columns["FK_ICProductAttributeSemiProductSpecialityID"].ColumnEdit = repositoryItemLookUpEdit;
            gridView.Columns["FK_ICProductAttributeSemiProductSpecialityID"].MinWidth = 150;
            column.ColumnEdit = repositoryItemLookUpEdit;
            //this.RepositoryItems.Add(repositoryItemLookUpEdit);
            ...
            SetFormat("ICProductItemQty", "n2", gridView);
        ...
        void repositoryItemAttributeQualityLookupEdit_QueryPopUp(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            RepositoryItemLookUpEdit rep = (DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit)lookUpEdit.Properties;
            if (rep != null)
            {
                string attributeGroup = string.Empty;
                if (rep.Tag != null)
                    attributeGroup = rep.Tag.ToString();
                ICProductAttributesController productAttributeController = new ICProductAttributesController();
                List<ICProductAttributesInfo> collection = productAttributeController.GetProductAttributesByProductAttributeGroup(attributeGroup);
