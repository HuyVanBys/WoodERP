...
{
    public partial class PackagingProfileManagementHistoryGridControl : BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            ProductionNormEntities entity = (ProductionNormEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            BindingSource bds = new BindingSource();
            bds.DataSource = entity.PackagingProfileManagementHistoryList;
            DataSource = bds;
        }
        protected override GridView InitializeGridView()
        {
            ...
            foreach (GridColumn column in gridView.Columns)
            {
                ...
                if (column.FieldName == "MMProfileManagementItemUpdateDate")
                {
                    ...
                    column.DisplayFormat.FormatString = "{0:dd/MM/yyyy HH:mm:tt}";
                }
            }
