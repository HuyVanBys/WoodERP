...
namespace BOSERP.Modules.CarcassBOM
{
    public partial class ProfileManagementItemsGridControl : BOSGridControl
    {
        ...
        protected override void AddColumnsToGridView(string strTableName, DevExpress.XtraGrid.Views.Grid.GridView gridView)
        {
            ...
            {
                if (columns.FieldName == "MMProfileManagementItemUpdateUser")
                {
                    ...
                    repositoryItemLookUpEdit.Columns.Add(new LookUpColumnInfo("HREmployeeName", "Nhân viên"));
        ...
        private void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                ((CarcassBOMModule)Screen.Module).RemoveProfileItemList();
            }
        }
        ...
        private void gridView1_CustomColumnDisplayText(object sender, CustomColumnDisplayTextEventArgs e)
        {
            ...
            if (e.Column.FieldName == "MMProfileManagementItemUpdateUser")
            {
                int value = 0;
                if (e.Value != null)
                {
