...
namespace BOSERP.Modules.OperationDetailPlan
{
    public partial class guiChooseOperation : BOSERPScreen
    {
        ...
        private void guiChooseOperation_Load(object sender, EventArgs e)
        {
            ...
            MMOperationsInfo obj = new MMOperationsInfo();
            obj.MMOperationName = "Tất cả";
            bindingListSource.Add(obj);
            ...
            //AddTreeListColumns(fld_trlGroupItems, 3, "MMOperationDesc", "Mã nhân viên", true, false, string.Empty, false);
            AddTreeListColumns(fld_trlGroupItems, 4, "MMOperationInOutStockCheck", "CĐ nhập kho", true, false, string.Empty, false);
            //AddTreeListColumns(fld_trlGroupItems, 5, "MMOperationCapacity", "CĐ ghi năng suất", true, false, string.Empty, false);
            //AddTreeListColumns(fld_trlGroupItems, 6, "MMOperationNeedQC", "CĐ có QC", true, false, string.Empty, false);
