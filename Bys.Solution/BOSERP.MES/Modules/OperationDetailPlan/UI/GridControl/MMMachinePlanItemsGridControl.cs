...
{
    public class MMMachinePlanItemsGridControl : BOSGridControl
    {
        ...
        protected override void GridView_CustomDrawCell(object sender, RowCellCustomDrawEventArgs e)
        {
            ...
            if (e.Column.FieldName == "Selected" && e.RowHandle >= 0 && !IsEdit)
            {
                try
                {
                    ...
                    int stase = ((OperationDetailPlanModule)this.Screen.Module).CheckTicketMergeMultiMachine(item);
                    if (stase == 0)
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.MachineDetailPlanItemsList;
            this.DataSource = bds;
        }
        void gridView_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            if (row != null && e.Column.FieldName == "Selected")
            {
                IsEdit = true;
                ((OperationDetailPlanModule)this.Screen.Module).EnableCancelMachineButton(true);
                ((OperationDetailPlanModule)this.Screen.Module).SetMachineTotalQty();
            }
        }
        ...
        void ViewMachine_Click(object sender, EventArgs e)
        {
            ...
            if (gridView.FocusedRowHandle >= 0)
            {
                ...
                {
                    ((OperationDetailPlanModule)Screen.Module).ShowDataMachine(obj, false);
                }
