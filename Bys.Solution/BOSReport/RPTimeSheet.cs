...
namespace BOSReport
{
    public partial class RPTimeSheet : BaseReport
    {
        public RPTimeSheet()
        {
            InitializeComponent();
        ...
        private void xrTableCell21_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            decimal number = 0;
            decimal.TryParse(GetCurrentColumnValue("HREmployeeAbsentPermission").ToString(), out number);
            if (number == 0)
            {
                xrTableCell21.Text = "";
            }
        ...
        private void xrTableCell23_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            XRTableCell cell = (XRTableCell)sender;
            decimal number = 0;
            decimal.TryParse(GetCurrentColumnValue("HREmployeeOTAtNight").ToString(), out number);
            if (number == 0)
            {
                xrTableCell23.Text = "";
            }
        ...
        private void xrTableCell4_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            XRTableCell cell = (XRTableCell)sender;
            decimal number = 0;
            decimal.TryParse(GetCurrentColumnValue("HREmployeeAbsentUnpermission").ToString(), out number);
            if (number == 0)
            {
                xrTableCell4.Text = "";
            }
        ...
        private void xrTableCell22_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            XRTableCell cell = (XRTableCell)sender;
            decimal number = 0;
            decimal.TryParse(GetCurrentColumnValue("HREmployeeOTAtDay").ToString(), out number);
            if (number == 0)
            {
                xrTableCell22.Text = "";
            }
        ...
        private void xrTableCell2_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            XRTableCell cell = (XRTableCell)sender;
            decimal number = 0;
            decimal.TryParse(GetCurrentColumnValue("HREmployeeOTOnSundayAtDay").ToString(), out number);
            if (number == 0)
            {
                xrTableCell2.Text = "";
            }
        ...
        private void xrTableCell7_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            XRTableCell cell = (XRTableCell)sender;
            decimal number = 0;
            decimal.TryParse(GetCurrentColumnValue("HREmployeeOTOnSundayAtNight").ToString(), out number);
            if (number == 0)
            {
                xrTableCell7.Text = "";
            }
        ...
        private void xrTableCell30_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            XRTableCell cell = (XRTableCell)sender;
            decimal number = 0;
            decimal.TryParse(GetCurrentColumnValue("HREmployeeOTLeAtDay").ToString(), out number);
            if (number == 0)
            {
                xrTableCell30.Text = "";
            }
        ...
        private void xrTableCell6_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            XRTableCell cell = (XRTableCell)sender;
            decimal number = 0;
            decimal.TryParse(GetCurrentColumnValue("HREmployeeOTLeAtNight").ToString(), out number);
            if (number == 0)
            {
                xrTableCell6.Text = "";
            }
        ...
        private void xrTableCell19_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            XRTableCell cell = (XRTableCell)sender;
            decimal number = 0;
            decimal.TryParse(GetCurrentColumnValue("HREmployeeAnnualLeave").ToString(), out number);
            if (number == 0)
            {
                xrTableCell19.Text = "";
            }
