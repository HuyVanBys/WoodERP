...
namespace BOSReport
{
    public partial class RP059 : BaseReport
    {
        ...
        private void xrTableCell2_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (IsOpeningBalance || IsEndBalance)
            {
                xrTableCell24.Font = new Font(xrTableCell2.Font.FontFamily, xrTableCell2.Font.Size, FontStyle.Bold);
            }
            else
            {
                xrTableCell24.Font = new Font(xrTableCell2.Font.FontFamily, xrTableCell2.Font.Size, FontStyle.Regular);
            }
        }
        ...
        private void xrLabel28_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            (sender as XRLabel).Text = String.Format("Ngày {0} tháng {1} năm {2}", currentDate.Day.ToString(), currentDate.Month.ToString(), currentDate.Year.ToString());
        }
    }
}
