...
namespace BOSERP.Utilities
{
    public static class EInvoiceHelper
    {
        ...
        public static void CreateEInvoice(ARInvoicesInfo objInvoicesInfo, List<ARInvoiceItemsInfo> invoiceItems, bool isDuplicate, string oldInvoiceNumber)
        {
            ...
            objEInvoiceGeneralsInfo.DiscountAmount = Math.Round(objInvoicesInfo.ARInvoiceDiscountFix + invoiceItems.Sum(o => o.ARInvoiceItemDiscountAmount), 0, MidpointRounding.AwayFromZero);
            ...
            objEInvoiceGeneralsInfo.TotalAmountWithVATInWords = ConvertAmountToWord.ReadAmount(objEInvoiceGeneralsInfo.TotalAmountWithVAT.ToString(), objInvoicesInfo.FK_GECurrencyID);
        ...
        public static void UpdateEInvoice(ACEInvoiceGeneralsInfo objEInvoiceGeneralsInfo, ARInvoicesInfo objInvoicesInfo, List<ARInvoiceItemsInfo> invoiceItems)
        {
            ...
            objEInvoiceGeneralsInfo.FK_GECurrencyID = objInvoicesInfo.FK_GECurrencyID;
            ...
            GECurrenciesInfo objCurrenciesInfo = (GECurrenciesInfo)(new GECurrenciesController()).GetObjectByID(objInvoicesInfo.FK_GECurrencyID);
            ...
            objEInvoiceGeneralsInfo.ExchangeRate = objInvoicesInfo.ARInvoiceExchangeRate;
            ...
            invoiceItems.ForEach(o =>
            {
                ...
                objEInvoiceDetailsInfo.UnitPrice = Math.Round(o.ARInvoiceItemProductUnitPrice, 2, MidpointRounding.AwayFromZero);
