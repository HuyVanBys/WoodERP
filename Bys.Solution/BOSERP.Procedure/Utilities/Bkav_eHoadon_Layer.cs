...
namespace BOSERP.Utilities
{
    ...
    {
        //public const string BkavPartnerGUID = "d5fcf4af-2f7d-4653-92ca-2e968a083d91"; // -TO EDIT- (2) Do Bkav cấp cho từng đối tác, mỗi đối tác 1 GUID khác nhau
        //public const string BkavPartnerToken = "ZE0rZPnR39ZG7DcFeVcaFOy19ur7tz20u6aNmQkcfM0=:4d+JQ8QS55l2sseTwecuTA=="; // -TO EDIT- (1) Do Bkav cấp cho từng đối tác, mỗi đối tác 1 mã khác nhau
        public const long Mode = RemoteCommand.DefaultMode; // -TO EDIT- (3) Do Bkav cấp cho từng đối tác, mỗi đối tác 1 mã khác nhau
    ...
    public static class CommandType
    {
        ...
        public const int GetListInvoiceWS_CK = 806;//Lấy ds thông tin của Hóa đơn chờ ký
    ...
    public class InvoiceDetailsWS
    {
        ...
        /// <summary>
        /// ID thuế suất: 1	0%, 2	5%, 3	10%, 4	Không chịu thuế, 5	Không kê khai thuế, 9 8%
        /// </summary>
