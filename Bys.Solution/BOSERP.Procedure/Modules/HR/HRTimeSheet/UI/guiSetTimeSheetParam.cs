...
{
    public partial class guiSetTimeSheetParam : BOSERPScreen
    {
        public DateTime Fromdate { get; set; }
        public DateTime Todate { get; set; }
        public guiSetTimeSheetParam()
        {
            InitializeComponent();
        }

        private void guiSetTimeSheetParam_Load(object sender, EventArgs e)
        {
        ...
        private void fld_btnSet_Click(object sender, EventArgs e)
        {
            ...
            ((HRTimeSheetModule)Module).SetTimeSheetParam(employeeID, paramID, fromDate, toDate, bosCheckEdit1.Checked);
        }
    }
}
