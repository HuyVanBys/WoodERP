...
namespace BOSERP.Modules.HROverTime.UI
{
    public partial class guiSearchEmployee : BOSERPScreen
    {
        ...
        public void GetDataSouce()
        {
            ...
            EmployeeList = objEmployeesController.GetEmployeeList(branchID, departmentID, departmentRoomID, DepartmentRoomGroupItemID, DepartmentRoomGroupTeamItemID, status);
        ...
        {
            int id = 0;
            Int32.TryParse(fld_lkeFK_HRDepartmentRoomGroupItemID.EditValue.ToString(), out id);
            ...
            list = objDepartmentRoomGroupTeamItemsController.GetListFromHRDepartmentRoomGroupTeamItems(id);
