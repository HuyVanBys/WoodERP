...
{
    public partial class guiSearchEmployeeShift : BOSERPScreen
    {
        /// <summary>
        ...
        public guiSearchEmployeeShift(List<HREmployeesInfo> selectedEmployees)
        {
        ...
        private void guiSearchEmployee_Load(object sender, EventArgs e)
        {
            ...
            fld_lkeHREmployeeStatus.EditValue = string.Empty;
        ...
        public void GetDataSouce()
        {
            ...
            EmployeeList = objEmployeesController.GetEmployeeListByArrangementShift(branchID, departmentID, departmentRoomID, status, EmployeePayRollCalculatedWorkType.TableWork.ToString());
        ...
        private void fld_lkeFK_HRDepartmentRoomGroupItemID_QueryPopUp(object sender, CancelEventArgs e)
        {
            ...
            DepartmentRoomGroupItemsList = objDepartmentRoomGroupItemsController.GetBySomeConditions(null, departmentID, departmentRoomID);
            if (DepartmentRoomGroupItemsList != null)
            {
                DepartmentRoomGroupItemsList.Insert(0, new HRDepartmentRoomGroupItemsInfo());
            }
            fld_lkeFK_HRDepartmentRoomGroupItemID.Properties.DataSource = DepartmentRoomGroupItemsList;
        }
