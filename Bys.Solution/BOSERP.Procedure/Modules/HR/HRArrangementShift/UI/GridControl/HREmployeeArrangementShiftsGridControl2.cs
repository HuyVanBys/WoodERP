...
{
    public class HREmployeeArrangementShiftsGridControl2 : BOSComponent.BOSGridControl
    {
        public void InvalidateDataSource(List<HREmployeeArrangementShiftsInfo> employeeArrangementShifts)
        {
            BindingSource bds = new BindingSource();
            bds.DataSource = employeeArrangementShifts;
            this.DataSource = bds;
            RefreshDataSource();
        }
