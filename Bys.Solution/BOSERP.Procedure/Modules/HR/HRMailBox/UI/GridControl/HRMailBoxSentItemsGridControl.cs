...
{
    public partial class HRMailBoxSentItemsGridControl : BOSGridControl
    {
        ...
        protected override void AddColumnsToGridView(string strTableName, GridView gridView)
        {
            ...
            column.ColumnEdit = repositoryItemPictureEdit1;
        ...
        protected void gridView_CustomUnboundColumnData(object sender, DevExpress.XtraGrid.Views.Base.CustomColumnDataEventArgs e)
        {
        ...
        protected void GridView_RowClick(object sender, RowClickEventArgs e)
        {
            if (e.RowHandle >= 0)
            {
                ...
                ((HRMailBoxModule)Screen.Module).LoadSentItemContentMail(mailID);
            }
        }
    }
}
