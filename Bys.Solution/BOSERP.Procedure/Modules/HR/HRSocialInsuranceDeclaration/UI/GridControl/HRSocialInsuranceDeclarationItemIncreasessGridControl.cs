...
{
    public partial class HRSocialInsuranceDeclarationItemIncreasessGridControl : BOSGridControl
    {
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.IncreaseSocialInsuranceDeclarationItemList;
            DataSource = bds;
        }
        ...
        private BandedGridView InitializeBandedGridView(GridView gridView)
        {
            ...
            //Check loại bhxh
            ReloadGridColumnIncrease(bandedView, gridView);
        ...
        private void BandedView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                ((HRSocialInsuranceDeclarationModule)Screen.Module).RemoveSocialInsuranceDeclarationItemFromList();
            }
        }
        ...
        public void ReloadGridColumnIncrease(BandedGridView bandedView, GridView gridView)
        {
            //Thông tin chung
            ...
            if (column != null)
            {
                CreateNewColumn(column, gridBand7, false);
            }
            ...
            //Nhân thân khác
            column = gridView.Columns["HRSocialInsuranceDeclarationItemGuardiansOther"];
            if (column != null)
            {
                CreateNewColumn(column, gridBand11, true);
            }
