...
namespace BOSERP.Modules.PaymentProposal
{
    public partial class guiProposalApprovals : BOSERPScreen
    {
        ...
        public List<APPaymentProposalApprovalsInfo> ProposalApprovals { get; set; }
        #endregion

        public guiProposalApprovals(List<APPaymentProposalApprovalsInfo> proposalApprovals)
        {
            InitializeComponent();
        ...
        private void cardView1_CustomDrawCardCaption(object sender, DevExpress.XtraGrid.Views.Card.CardCaptionCustomDrawEventArgs e)
        {
            ...
            APPaymentProposalApprovalsInfo item = (APPaymentProposalApprovalsInfo)view.GetRow(e.RowHandle);
            if (item == null)
                return;
            
            Brush backBrush, foreBrush;
            switch (item.APPaymentProposalApprovalAction)
            {
                case "Approve":
            ...
            string caption = BOSApp.GetDisplayTextFromConfigValue("PaymentProposalApprovalAction", item.APPaymentProposalApprovalAction);
