...
{
    public class WorkProductEntities : ERPModuleEntities
    {
        ...
        public BOSList<ICProductWorkItemsInfo> ProductWorkItemMaterialList { get; set; }

        public BOSList<ICProductWorkItemsInfo> ProductWorkItemAssetList { get; set; }

        public BOSList<ICProductTasksInfo> ProductTaskList { get; set; }
        #endregion

        #region Constructor
        public WorkProductEntities()
            : base()
        {
            ...
            ProductWorkItemMaterialList = new BOSList<ICProductWorkItemsInfo>();
            ProductWorkItemAssetList = new BOSList<ICProductWorkItemsInfo>();
        ...
        public override void InitModuleObjectList()
        {
            ...
            ProductWorkItemMaterialList.InitBOSList(this,
                                               TableName.ICProductsTableName,
                                               TableName.ICProductWorkItemsTableName,
                                               BOSList<ICProductWorkItemsInfo>.cstRelationForeign);
            ProductWorkItemMaterialList.ItemTableForeignKey = "FK_ICProductWorkItemParentID";

            ProductWorkItemAssetList.InitBOSList(this,
                                               TableName.ICProductsTableName,
                                               TableName.ICProductWorkItemsTableName,
                                               BOSList<ICProductWorkItemsInfo>.cstRelationForeign);
            ProductWorkItemAssetList.ItemTableForeignKey = "FK_ICProductWorkItemParentID";

            ProductTaskList.InitBOSList(this,
                                               TableName.ICProductsTableName,
                                               TableName.ICProductTasksTableName,
                                               BOSList<ICProductTasksInfo>.cstRelationForeign);
            ProductTaskList.ItemTableForeignKey = "FK_ICProductID";
        }
        ...
        public override void InitGridControlInBOSList()
        {
            ...
            ProductWorkItemMaterialList.InitBOSListGridControl(WorkProductModule.ProductWorkMaterialItemsGridControlName);
            ProductWorkItemAssetList.InitBOSListGridControl(WorkProductModule.ProductWorkAssetItemsGridControlName);
            ProductTaskList.InitBOSListGridControl(WorkProductModule.ProductTasksGridControlName);
        }
        ...
        public override void SetDefaultModuleObjectsList()
        {
            try
            {
                ...
                ProductWorkItemMaterialList.SetDefaultListAndRefreshGridControl();
                ProductWorkItemAssetList.SetDefaultListAndRefreshGridControl();
                ProductTaskList.SetDefaultListAndRefreshGridControl();
            }
            catch (Exception)
            {
                return;
        ...
        public override void InvalidateModuleObjects(int iObjectID)
        {
            ...
            List<ICProductWorkItemsInfo> productWorkItemList = objProductWorkItemsController.GetProductWorkItemsByProductWorkItemParentIDAndParentType(iObjectID, objProductsInfo.ICProductType);

            List<ICProductWorkItemsInfo> productWorkMaterialItemList = productWorkItemList.Where(p => p.ICProductWorkItemType == ProductWorkItemType.Material.ToString()).ToList();
            List<ICProductWorkItemsInfo> productWorkAssetItemList = productWorkItemList.Where(p => p.ICProductWorkItemType == ProductWorkItemType.Asset.ToString()).ToList();
            ProductWorkItemMaterialList.Invalidate(productWorkMaterialItemList);
            ProductWorkItemAssetList.Invalidate(productWorkAssetItemList);

            ProductTaskList.Invalidate(iObjectID);
        }
        #endregion
        ...
        public override void SaveModuleObjects()
        {
            ...
            ProductWorkItemMaterialList.SaveItemObjects();
            ProductWorkItemAssetList.SaveItemObjects();

            ProductTaskList.SaveItemObjects();
        }
        ...
        public override void SetDefaultMainObject()
        {
            ...
            objProductsInfo.ICProductType = ProductType.Work.ToString();
