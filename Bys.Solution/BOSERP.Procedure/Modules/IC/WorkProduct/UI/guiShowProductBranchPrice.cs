...
namespace BOSERP.Modules.WorkProduct
{
    public partial class guiShowProductBranchPrice : BOSERPScreen
    {
        ...
        private void guiShowProductBranchPrice_Load(object sender, EventArgs e)
        {
            ...
            WorkProductEntities entity = (WorkProductEntities)((BaseModuleERP)Module).CurrentModuleEntity;
            entity.ProductBranchPriceList.InitBOSListGridControl(fld_dgcICProductBranchPrices);
            ((WorkProductModule)Module).InvalidateProductBranchPriceWithCurrency(fld_dgcICProductBranchPrices);
        }
