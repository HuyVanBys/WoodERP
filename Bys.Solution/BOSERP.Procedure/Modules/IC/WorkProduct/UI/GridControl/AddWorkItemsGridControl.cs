...
{
    public class AddWorkItemsGridControl : BOSGridControl
    {
        ...
        protected override DevExpress.XtraGrid.Views.Grid.GridView InitializeGridView()
        {
            ...
            if (gridView.Columns["ICProductChargeCheck"] != null)
            {
                gridView.Columns["ICProductChargeCheck"].OptionsColumn.AllowEdit = true;
            }
