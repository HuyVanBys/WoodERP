...
{
    public class TransferConstructionEntities : GLTransferEntities
    {
        ...
        #region Constructor
        public TransferConstructionEntities()
            : base()
        {
        ...
        {
            TransferItemList.InitBOSListGridControl("fld_dgcICTransferConstructionItems");
        ...
        public override void SetDefaultMainObject()
        {
            ...
            transfer.ICTransferTransferType = TransferTransferType.TransferConstruction.ToString();
