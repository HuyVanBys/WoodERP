...
namespace BOSERP.Modules.PurchaseReceipt
{
    public class MultiProductReceiptItemsGridControl : BOSGridControl
    {
        ...
        {
            PurchaseReceiptEntities entity = (PurchaseReceiptEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            ((PurchaseReceiptModule)Screen.Module).TranferReceiptItemFromListToList(ReceiptItemType.MultiPackage.ToString(), entity.MultiProductReceiptComponentItemsList, entity.MultiPackageReceiptComponentItemsList);
        }

        private void MultiPackageMultiProduct_Click(Object sender, System.EventArgs e)
        {
            PurchaseReceiptEntities entity = (PurchaseReceiptEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            ((PurchaseReceiptModule)Screen.Module).TranferReceiptItemFromListToList(ReceiptItemType.MultiPackageProduct.ToString(), entity.MultiProductReceiptComponentItemsList, entity.MultiReceiptComponentItemsList);
        }
    }
}
