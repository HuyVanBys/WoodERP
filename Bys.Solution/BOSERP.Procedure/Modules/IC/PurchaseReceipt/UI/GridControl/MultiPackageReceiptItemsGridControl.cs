...
namespace BOSERP.Modules.PurchaseReceipt
{
    public class MultiPackageReceiptItemsGridControl : BOSGridControl
    {
        ...
        {
            PurchaseReceiptEntities entity = (PurchaseReceiptEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            ((PurchaseReceiptModule)Screen.Module).TranferReceiptItemFromListToList(ReceiptItemType.MultiProduct.ToString(), entity.MultiPackageReceiptComponentItemsList, entity.MultiProductReceiptComponentItemsList);
        }

        private void MultiPackageMultiProduct_Click(Object sender, System.EventArgs e)
        {
            PurchaseReceiptEntities entity = (PurchaseReceiptEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            ((PurchaseReceiptModule)Screen.Module).TranferReceiptItemFromListToList(ReceiptItemType.MultiPackageProduct.ToString(), entity.MultiPackageReceiptComponentItemsList, entity.MultiReceiptComponentItemsList);
        }
        ...
        private void ReposIdentifyPackageSupplierNo_Click(object sender, EventArgs e)
        {
            ...
            if (gridView.FocusedRowHandle >= 0)
            {
                ...
                PurchaseReceiptEntities entity = (PurchaseReceiptEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
                ((PurchaseReceiptModule)Screen.Module).IdentifyPackageSupplierNo(objReceiptComponentItemsInfo, entity.MultiPackageReceiptComponentItemsList);
            }
        }
    }
}
