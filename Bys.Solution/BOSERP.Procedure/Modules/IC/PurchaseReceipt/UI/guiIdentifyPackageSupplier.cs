...
namespace BOSERP.Modules.PurchaseReceipt
{
    public partial class guiIdentifyPackageSupplier : BOSERPScreen
    {
        ...
        {
            ((PurchaseReceiptModule)Module).RollbackReceiptItemPackageList(ReceiptComponentItemsObject);
            Close();
        }
        ...
        {
            if (!((PurchaseReceiptModule)Module).CheckSumReceiptItemPackageQty(ReceiptComponentItemsObject))
            {
                return;
            }
