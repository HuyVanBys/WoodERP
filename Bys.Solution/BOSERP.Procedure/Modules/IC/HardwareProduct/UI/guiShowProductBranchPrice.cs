...
namespace BOSERP.Modules.HardwareProduct
{
    public partial class guiShowProductBranchPrice : BOSERPScreen
    {
        ...
        private void guiShowProductBranchPrice_Load(object sender, EventArgs e)
        {
            ...
            HardwareProductEntities entity = (HardwareProductEntities)((BaseModuleERP)Module).CurrentModuleEntity;
            entity.ProductBranchPriceList.InitBOSListGridControl(fld_dgcICProductBranchPrices);
            ((HardwareProductModule)Module).InvalidateProductBranchPriceWithCurrency(fld_dgcICProductBranchPrices);
        }
