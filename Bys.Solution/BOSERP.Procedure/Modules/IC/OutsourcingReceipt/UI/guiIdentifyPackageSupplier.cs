...
namespace BOSERP.Modules.OutsourcingReceipt
{
    public partial class guiIdentifyPackageSupplier : BOSERPScreen
    {
        ...
        {
            ((OutsourcingReceiptModule)Module).RollbackReceiptItemPackageList(ReceiptComponentItemsObject);
            Close();
        }
        ...
        private void guiIdentifyPackageSupplier_Load(object sender, EventArgs e)
        {
            ...
            {
                OutsourcingReceiptEntities entity = (OutsourcingReceiptEntities)((BaseModuleERP)Module).CurrentModuleEntity;
        ...
        {
            if (!((OutsourcingReceiptModule)Module).CheckSumReceiptItemPackageQty(ReceiptComponentItemsObject))
            {
                return;
            }
