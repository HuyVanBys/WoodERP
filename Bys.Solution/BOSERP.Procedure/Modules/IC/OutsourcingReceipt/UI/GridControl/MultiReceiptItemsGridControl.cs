...
namespace BOSERP.Modules.OutsourcingReceipt
{
    public class MultiReceiptItemsGridControl : BOSGridControl
    {
        ...
        {
            OutsourcingReceiptEntities entity = (OutsourcingReceiptEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            ((OutsourcingReceiptModule)Screen.Module).TranferReceiptItemFromListToList(ReceiptItemType.MultiPackage.ToString(), entity.MultiReceiptComponentItemsList, entity.MultiPackageReceiptComponentItemsList);
        }

        private void MultiProduct_Click(Object sender, System.EventArgs e)
        {
            OutsourcingReceiptEntities entity = (OutsourcingReceiptEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            ((OutsourcingReceiptModule)Screen.Module).TranferReceiptItemFromListToList(ReceiptItemType.MultiProduct.ToString(), entity.MultiReceiptComponentItemsList, entity.MultiProductReceiptComponentItemsList);
        }
        ...
        private void ReposIdentifyPackageSupplierNo_Click(object sender, EventArgs e)
        {
            ...
            if (gridView.FocusedRowHandle >= 0)
            {
                ...
                OutsourcingReceiptEntities entity = (OutsourcingReceiptEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
                ((OutsourcingReceiptModule)Screen.Module).IdentifyPackageSupplierNo(objReceiptComponentItemsInfo, entity.MultiReceiptComponentItemsList);
            }
        }
    }
}
