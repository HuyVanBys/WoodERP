namespace BOSERP.Modules.OutsourcingReceipt
{
    partial class guiReceiptHistory
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fld_dgcGEHistoryDetails = new BOSERP.Modules.OutsourcingReceipt.GEHistoryDetailsGridControl();
            this.BOSLine1 = new BOSComponent.BOSLine(this.components);
            this.bosLine2 = new BOSComponent.BOSLine(this.components);
            this.fld_dgcICReceiptItemLogs = new BOSERP.Modules.OutsourcingReceipt.ICReceiptItemLogsGridControl();
