...
{
    public class PackagingProductEntities : ERPModuleEntities
    {
        ...
        public const String strICProductItemsObjectName = "ICProductItems";
        ...
        public BOSList<ICPackagingNormItemsInfo> ICPackagingNormItemsList { get; set; }
        ...
        #region Constructor
        public PackagingProductEntities()
            : base()
        {
            ...
            ICPackagingNormItemsList = new BOSList<ICPackagingNormItemsInfo>();
        ...
        {
            ModuleObjects.Add(TableName.ICProductItemsTableName, new ICProductItemsInfo());
            ...
            ModuleObjects.Add(TableName.ICPackagingNormItemsTableName, new ICPackagingNormItemsInfo());
        ...
        public override void InitModuleObjectList()
        {
            ...
            ICProductItemsList.ItemTableForeignKey = "FK_ICProductID";
            ...
            ICPackagingNormItemsList.InitBOSList(this,
                                                    TableName.ICProductsTableName,
                                                    TableName.ICPackagingNormItemsTableName,
                                                    BOSList<ICProductBranchPricesInfo>.cstRelationForeign);
            ICPackagingNormItemsList.ItemTableForeignKey = "FK_ICProductParentID";
        ...
        public override void InitGridControlInBOSList()
        {
            ...
            ICPackagingNormItemsList.InitBOSListGridControl();
        ...
        public override void SetDefaultMainObject()
        {
            ...
            {
                objProductsInfo.FK_ICDepartmentID = objICDepartmentsInfo.ICDepartmentID;
            }
        ...
        public override void SetDefaultModuleObjectsList()
        {
            try
            {
                ...
                ICPackagingNormItemsList.SetDefaultListAndRefreshGridControl();
        ...
        public override void DuplicateModuleObjectList()
        {
            ...
            ICPackagingNormItemsList.Duplicate();
        ...
        public override void InvalidateModuleObjects(int iObjectID)
        {
            ...
            ICPackagingNormItemsList.Invalidate(iObjectID);
        ...
        public override void SaveModuleObjects()
        {
            ...
            ICPackagingNormItemsList.SaveItemObjects();
