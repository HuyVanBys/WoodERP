...
namespace BOSERP.Modules.PackagingProduct
{
    public partial class guiShowProductBranchPriceHistory : BOSERPScreen
    {
        ...
        private void guiShowProductBranchPrice_Load(object sender, EventArgs e)
        {
            ...
            PackagingProductEntities entity = (PackagingProductEntities)((BaseModuleERP)Module).CurrentModuleEntity;
            entity.ProductBranchPriceList.InitBOSListGridControl(fld_dgcICProductBranchPricesHistory);
            ((PackagingProductModule)Module).InvalidateProductBranchPriceHistoryWithCurrency(fld_dgcICProductBranchPricesHistory);
        }
