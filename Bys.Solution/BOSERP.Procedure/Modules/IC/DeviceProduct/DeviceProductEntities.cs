...
{
    public class DeviceProductEntities : ERPModuleEntities
    {
        ...
        public override void InitGridControlInBOSList()
        {
            ...
            ProductFilesList.InitBOSListGridControl(DeviceProductModule.ICProductImagesGridControlName);
        ...
        public override void SetDefaultMainObject()
        {
            ...
            objProductsInfo.ICProductType = configValuesController.GetObjectByGroupAndValue("ProductType", ProductType.Device.ToString()).ADConfigKeyValue;
        ...
        public void UpdateImages(List<ICProductFilesInfo> productImageList)
        {
            ...
            ProductFilesList.Invalidate(productImageList);
