...
namespace BOSERP.Modules.WoodPurchaseReceipt
{
    public partial class guiPrintPackageBarcode : BOSERPScreen
    {
        ...
        {
            ((WoodPurchaseReceiptModule)Module).SearchPackagesForPrinting(fld_txtICProductSupplierNumber.Text);
        }
        ...
        private void fld_chkSellectAll_CheckedChanged(object sender, EventArgs e)
        {
            ...
            ((WoodPurchaseReceiptModule)Module).SelectAllPrintedPackages(selectAllCheckEdit.Checked);
        }
    }
}
