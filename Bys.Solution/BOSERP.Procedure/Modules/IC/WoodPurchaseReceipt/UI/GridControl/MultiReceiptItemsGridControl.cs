...
namespace BOSERP.Modules.WoodPurchaseReceipt
{
    public class MultiReceiptItemsGridControl : BOSGridControl
    {
        ...
        {
            WoodPurchaseReceiptEntities entity = (WoodPurchaseReceiptEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            ((WoodPurchaseReceiptModule)Screen.Module).TranferReceiptItemFromListToList(ReceiptItemType.MultiPackage.ToString(), entity.MultiReceiptComponentItemsList, entity.MultiPackageReceiptComponentItemsList);
        }

        private void MultiProduct_Click(Object sender, System.EventArgs e)
        {
            WoodPurchaseReceiptEntities entity = (WoodPurchaseReceiptEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            ((WoodPurchaseReceiptModule)Screen.Module).TranferReceiptItemFromListToList(ReceiptItemType.MultiProduct.ToString(), entity.MultiReceiptComponentItemsList, entity.MultiProductReceiptComponentItemsList);
        }
        ...
        private void ReposIdentifyPackageSupplierNo_Click(object sender, EventArgs e)
        {
            ...
            if (gridView.FocusedRowHandle >= 0)
            {
                ...
                WoodPurchaseReceiptEntities entity = (WoodPurchaseReceiptEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
                ((WoodPurchaseReceiptModule)Screen.Module).IdentifyPackageSupplierNo(objReceiptComponentItemsInfo, entity.MultiReceiptComponentItemsList);
            }
        }
    }
}
