...
{
    public partial class APPurchaseOrderFiltersGridControl : BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            HomeEntities entity = (HomeEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            BindingSource bds = new BindingSource();
            bds.DataSource = entity.PurchaseOrderFilterList;
            DataSource = bds;
        }
        ...
        {
            HomeEntities entity = (HomeEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            entity.PurchaseOrderFilterList.SetEndCurrentEdit();
            return;
        }
    }
}
