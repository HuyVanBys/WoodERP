...
{
    public partial class VehicleFuelLogsGridControl : BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            VehicleEntities entity = (VehicleEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            BindingSource bds = new BindingSource();
            bds.DataSource = entity.VehicleFuelLogList;
            DataSource = bds;
        }
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                ((VehicleModule)Screen.Module).RemoveSelectedItemFromVehicleFuelLogList();
            }
