...
{
    public class ElectronicInvoiceMInvoiceEntities : ERPModuleEntities
    {
        ...
        #region Constructor
        public ElectronicInvoiceMInvoiceEntities() : base()
        {
        ...
        public override void InitGridControlInBOSList()
        {
            ...
            EInvoiceTemplateList.InitBOSListGridControl(ElectronicInvoiceMInvoiceModule.EInvoiceGridControlName);
        }
        ...
        public override void SetDefaultMainObject()
        {
            ...
            ACEInvoiceTypesInfo objEInvoiceGeneralsInfo = (new ACEInvoiceTypesController()).GetLastObject();
            mainObject.TemplateCode = objEInvoiceGeneralsInfo.ACEInvoiceTypeTemplateCode;
            mainObject.InvoiceSeries = objEInvoiceGeneralsInfo.ACEInvoiceTypeSeries;
            mainObject.InvoiceType = objEInvoiceGeneralsInfo.ACEInvoiceTypeNo;
        ...
        {
            ACEInvoiceDetailsController controller = new ACEInvoiceDetailsController();
            EInvoiceDetailsList.Invalidate(controller.GetInvoiceDetailsByEInvoiceID(iObjectID));
