...
{
    public class EquipmentReceiptEntities : GLReceiptEntities
    {
        ...
        #region Constructor
        public EquipmentReceiptEntities()
            : base()
        {
        ...
        {
            ReceiptItemsList.InitBOSListGridControl(EquipmentReceiptModule.ReceiptItemGridControlName);
            DocumentEntryList.InitBOSListGridControl(EquipmentReceiptModule.DocumentEntryGridControlName);
        }
        ...
        public override void SetDefaultMainObject()
        {
            ...
            objReceiptsInfo.ICReceiptTypeCombo = ReceiptType.EquipmentReceipt.ToString();
        ...
        public override void SetValuesAfterValidateProduct(int iICProductID)
        {
            ...
            if (objProductsInfo != null)
            {
                ...
                objICReceiptItemsInfo.ICProductSerieNo = objProductsInfo.ICProductNo;
