...
namespace BOSERP.Modules.ElectronicInvoice
{
    public partial class EInvoiceDetailsGridControl : BOSGridControl
    {
        ...
        protected override GridView InitializeGridView()
        {
            ...
            {
                if (col.FieldName == "VatPercentage" || col.FieldName == "VatAmount" || col.FieldName == "ACEInvoiceDetailTotalAmount")
        ...
        protected override void GridView_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            {
                if (e.Column.FieldName == "UnitPrice" || e.Column.FieldName == "Quantity")
                {
                    ((ElectronicInvoiceModule)Screen.Module).UpdateTotalAmount();
                }
                ...
                {
                    ((ElectronicInvoiceModule)Screen.Module).ChangeItemCode(objEInvoiceDetailsInfo);
                }
            }
        }
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                ((ElectronicInvoiceModule)Screen.Module).RemoveSelectedItem();
            }
        }
    }
}
