...
{
    public partial class ProposalAreasGridControl : BOSGridControl
    {
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.ProposalAreasList;
            this.DataSource = bds;
        }
        ...
        protected override GridView InitializeGridView()
        {
            ...
            if (gridview.Columns["ARProposalAreaNo"] != null)
                gridview.Columns["ARProposalAreaNo"].OptionsColumn.AllowEdit = true;
            if (gridview.Columns["ARProposalAreaName"] != null)
                gridview.Columns["ARProposalAreaName"].OptionsColumn.AllowEdit = true;
            if (gridview.Columns["ARProposalAreaDesc"] != null)
                gridview.Columns["ARProposalAreaDesc"].OptionsColumn.AllowEdit = true;

            objProductsInfoList = ((ProposalModule)Screen.Module).GetWoodIngredient();
            ...
            GridColumn column = gridview.Columns["ICProductName"];
            if (column != null)
            {
                column.Group();
                GridGroupSummaryItem summaryItem = (GridGroupSummaryItem)gridview.GroupSummary.Add(SummaryItemType.Sum, "ARProposalAreaTotalAmount");
        ...
        {
            e.RelationName = "FK_ARProposalAreaID";
        }
        ...
        void gridview_MasterRowGetChildList(object sender, MasterRowGetChildListEventArgs e)
        {
            ...
            if (gridview == null)
                return;
            ARProposalAreasInfo productTem = (ARProposalAreasInfo)gridview.GetRow(e.RowHandle);
            if (productTem == null)
                return;
            if (productTem.ItemList == null)
                productTem.ItemList = new BindingList<ARProposalAreaItemsInfo>();
        ...
        void gridview_MasterRowExpanded(object sender, CustomMasterRowEventArgs e)
        {
            ...
            List<BOSLib.AAColumnAliasInfo> columnAlias = reportController.GetByTableNameWithNumberIntOrder("ARProposalAreaItems");
            ...
            columnAlias.ForEach(col =>
            {
                ...
                else if (column.FieldName == "ARProposalAreaItemLength"
                        || column.FieldName == "ARProposalAreaItemWidth"
                        || column.FieldName == "ARProposalAreaItemHeight"
                        || column.FieldName == "ARProposalAreaItemProductUnitPrice"
                        || column.FieldName == "ARProposalAreaItemTotalAmount")
                {
                ...
                else if (column.FieldName == "ARProposalAreaItemProductQty")
                {
                    RepositoryItemTextEdit txt = new RepositoryItemTextEdit();
                    txt.Mask.MaskType = DevExpress.XtraEditors.Mask.MaskType.Numeric;
                    txt.DisplayFormat.FormatType = FormatType.Numeric;
        ...
        void detail_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Delete)
            {
                ...
                BindingList<ARProposalAreaItemsInfo> lst = (BindingList<ARProposalAreaItemsInfo>)view.DataSource;
                ARProposalAreaItemsInfo item = (ARProposalAreaItemsInfo)view.GetFocusedRow();
                lst.Remove(item);
                view.RefreshData();
        ...
        private void detail_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            if (view != null)
            {
                ...
                if (item != null)
                {
                    ...
                    ((ProposalModule)Screen.Module).ChangedProposalAreaItemList(item);
                }
            }
        }

        public void ChangeIngredient(ARProposalAreaItemsInfo item, ICProductsInfo iProduct)
        {
            item.ARProposalAreaItemProductNo = iProduct.ICProductNo;
            item.ARProposalAreaItemProductName = iProduct.ICProductName;
            item.ARProposalAreaItemProductDesc = iProduct.ICProductDesc;
            item.ARProposalAreaItemProductQty = 1;
            item.ARProposalAreaItemProductUnitPrice = iProduct.ICProductPrice01;
            item.FK_ICMeasureUnitID = iProduct.FK_ICProductBasicUnitID;
            item.ARProposalAreaItemHeight = iProduct.ICProductHeight;
            item.ARProposalAreaItemLength = iProduct.ICProductLength;
            item.ARProposalAreaItemWidth = iProduct.ICProductWidth;
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Delete)
            {
                ((ProposalModule)Screen.Module).DeleteProductTemplates();
            }
        }
