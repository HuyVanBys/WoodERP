...
namespace BOSERP.Modules.SaleOrderForOther
{
    public class ARSaleOrderPaymentTimesGridControl : BOSGridControl
    {
        ...
        private void gridView1_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            ...
            {
                if (((SaleOrderForOtherModule)Screen.Module).Toolbar.IsNullOrNoneAction() && objSaleOrdersInfo.ARSaleOrderStatus == SaleOrderStatus.New.ToString())
                {
                    ((SaleOrderForOtherModule)Screen.Module).ActionEdit();
        ...
        protected override void GridView_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            if (entity.ARSaleOrderPaymentTimesList.CurrentIndex >= 0)
            {
                ...
                if (item.FK_GEPaymentTermID == 0 && mainObject.FK_GEPaymentTermID > 0)
                {
                    ...
                    ((SaleOrderForOtherModule)Screen.Module).ChangePaymentTimeAmount(mainObject.FK_GEPaymentTermID);
                ...
                if (e.Column.FieldName == "FK_GEPaymentTermID" || e.Column.FieldName == "ARSaleOrderPaymentTimePaymentType")
                {
                    ...
                    if (objPaymentTermItemsInfo != null)
                    {
                        ((SaleOrderForOtherModule)Screen.Module).ChangePaymentTimeAmount(item.FK_GEPaymentTermID);
                        //item.ARSaleOrderPaymentTimeAmount = mainObject.ARSaleOrderTotalAmount * objPaymentTermsInfo.GEPaymentTermPercentPayment / 100;
                    }
                    //TKChinh End
                }
                ...
                //{
                //if (!(((SaleOrderForOtherModule)Screen.Module).IsValidAmount()))
                //{
        ...
        {
            GridLocalizer.Active = new MyLocalizer2();
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                ((SaleOrderForOtherModule)Screen.Module).DeleteItemFromPaymentTimeItemsList();
            }
        }
...
public class MyLocalizer2 : DevExpress.XtraGrid.Localization.GridLocalizer
{
