...
{
    public class SaleOrderForOtherEntities : BaseTransactionEntities
    {
        ...
        #region Constructor
        public SaleOrderForOtherEntities()
            : base()
        {
        ...
        public override void InvalidateModuleObjects(int iObjectID)
        {
            ...
            {
                ((SaleOrderForOtherModule)Module).OrderTypeLookupEditControl.Enabled = true;
                ((SaleOrderForOtherModule)Module).TTMTLookupEditControl.Enabled = true;
                ((SaleOrderForOtherModule)Module).OrderPONoTextBoxControl.Enabled = true;
            }
            else
            {
                ((SaleOrderForOtherModule)Module).OrderTypeLookupEditControl.Enabled = false;
                ((SaleOrderForOtherModule)Module).TTMTLookupEditControl.Enabled = false;
                ((SaleOrderForOtherModule)Module).OrderPONoTextBoxControl.Enabled = false;
            }
        ...
        public override bool CompleteTransaction()
        {
            ...
            foreach (ARSaleOrderItemsInfo entItem in ComponentSaleOrderItemList)
            {
                if (entItem.FK_MMAllocationPlanItemID > 0)
                {
                    MMAllocationPlanItemsInfo objAllocationPlanItemsInfo = (MMAllocationPlanItemsInfo)objAllocationPlanItemsController.GetObjectByID(entItem.FK_MMAllocationPlanItemID);
