...
namespace BOSERP.Modules.SaleOrderForWood
{
    public partial class LumberItemsGridControl : ItemGridControl
    {
            ...
            if (entity.LumberWoodList.CurrentIndex >= 0)
            {
                ...
                if (e.Column.FieldName == "ARSaleOrderItemProductQty")
                {
                    ...
                    if (item.ARSaleOrderItemProductQty > item.ARSaleOrderItemProductInventoryQty)
                    {
                        ...
                        entity.LumberWoodList[entity.LumberWoodList.CurrentIndex].ARSaleOrderItemProductQty = Convert.ToDecimal(gridView.ActiveEditor.OldEditValue);
                    }
                }
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                ((SaleOrderForWoodModule)Screen.Module).DeleteItemLumberWoodList();
            }
