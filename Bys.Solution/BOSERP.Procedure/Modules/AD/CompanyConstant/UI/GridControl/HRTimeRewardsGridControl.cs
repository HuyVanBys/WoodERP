...
{
    public partial class HRTimeRewardsGridControl : BOSGridControl
    {
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.TimeRewardsList;
            this.DataSource = bds;
        }
        ...
        private BandedGridView InitializeBandedGridView(GridView gridView)
        {
            ...
            {
                if (column != null && ((column.FieldName == "HRTimeRewardSalesFrom")
                    || (column.FieldName == "HRTimeRewardSalesTo")))
                {
                ...
                if (column != null && (column.FieldName == "HRTimeRewardReceiptRate"))
                {
                    BandedGridColumn bandedColumn = ConvertToBandedColumn(column, true);
                ...
                if (column != null && (column.FieldName == "HRTimeRewardReceiptType"))
                {
                    ds = objConfigValuesController.GetADConfigValuesByGroup("TimeRewardReceiptType");
                    BandedGridColumn bandedColumn = ConvertToBandedColumn(column, true);
        ...
        private void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                ((CompanyConstantModule)Screen.Module).RemoveTimeRewards();
            }
        }
    }
}
