...
{
    public partial class ContainerTypeGridControl : BOSComponent.BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            CompanyConstantEntities entity = (CompanyConstantEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            BindingSource bds = new BindingSource();
            bds.DataSource = entity.ContainerTypeList;
            this.DataSource = bds;
        }
        ...
        protected void GridView_ValidatingEditor(object sender, BaseContainerValidateEditorEventArgs e)
        {
            ...
            if (e.Value != null)
            {
                if (gridView.FocusedColumn.FieldName == "ADConfigText")
                {
                    ...
                    {
                        e.ErrorText = CompanyConstantLocalizedResources.NotNullOrEmptyContTypeMessage.ToString();
                        e.Valid = false;
                    }
                    else
                    {
                        ...
                        {
                            string configValuesType = "Container";
        ...
        protected override void GridView_KeyUp(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            ...
            {
                ((CompanyConstantModule)Screen.Module).RemoveSelectedContainerType();
            }
        }
    }
}
