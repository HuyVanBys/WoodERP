...
{
    public partial class HRSplitRatiosGridControl : BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            CompanyConstantEntities entity = (CompanyConstantEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            BindingSource bds = new BindingSource();
            bds.DataSource = entity.SplitRatiosList;
            this.DataSource = bds;
        }
        ...
        protected override GridView InitializeGridView()
        {
            ...
            column = gridView.Columns["FK_CSCompanyID"];
            if (column != null)
            {
                column.OptionsColumn.AllowEdit = true;
            }
            column = gridView.Columns["HRSplitRatioGroup"];
            if (column != null)
            {
                column.OptionsColumn.AllowEdit = true;
            }
            column = gridView.Columns["HRSplitRatioRatio"];
            if (column != null)
            {
                column.OptionsColumn.AllowEdit = true;
            }
            ...
            //         || col.FieldName == "FK_ACAccountCostID"
            //         || col.FieldName == "FK_ACAccountCostExpiredID")
            //     {
        ...
        private void gridView_CustomColumnDisplayText(object sender, CustomColumnDisplayTextEventArgs e)
        {
            if (e.Column.FieldName == "FK_ACAccountID"
                || e.Column.FieldName == "FK_ACAccountCostID"
                || e.Column.FieldName == "FK_ACAccountCostExpiredID")
            {
                if (e.Value != null)
                {
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Delete)
            {
                ...
                {
                    ((CompanyConstantModule)Screen.Module).RemoveSplitRatio();
                }
            }
        }
    }
