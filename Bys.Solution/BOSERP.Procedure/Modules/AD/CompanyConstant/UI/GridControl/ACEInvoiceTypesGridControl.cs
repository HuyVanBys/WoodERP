...
namespace BOSERP.Modules.CompanyConstant
{
    public partial class ACEInvoiceTypesGridControl : BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.EInvoiceTypesList;
            this.DataSource = bds;
        }
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Delete)
            {
                ...
                {
                    ((CompanyConstantModule)Screen.Module).RemoveSelectedEInvoiceTypes();
                }
            }
        }
        ...
        protected override void GridView_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            ...
            objEInvoiceTypesInfo.ACEInvoiceTypeCombo = InvoiceTypeCombo.Purchase.ToString();
        }
    }
}
