...
{
    public partial class APSupplierTypeAccountConfigsGridControl : BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            CompanyConstantEntities entity = (CompanyConstantEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            BindingSource bds = new BindingSource();
            bds.DataSource = entity.APSupplierTypeAccountConfigsList;
            this.DataSource = bds;
        }
        ...
        protected override GridView InitializeGridView()
        {
            ...
            foreach (GridColumn col in gridView.Columns)
            {
                ...
                if (col.FieldName == "FK_ACAccountSaleID"
                    || col.FieldName == "FK_ACAccountPurchaseID"
                    || col.FieldName == "FK_ACAccountDepositID")
                {
        ...
        {
            if (e.Column.FieldName == "FK_ACAccountSaleID"
                || e.Column.FieldName == "FK_ACAccountPurchaseID"
                || e.Column.FieldName == "FK_ACAccountDepositID")
            {
                if (e.Value != null)
                {
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Delete)
            {
                ...
                {
                    ((CompanyConstantModule)Screen.Module).RemoveSupplierTypeAccountConfig();
                }
            }
        }
    }
