...
{
    public partial class ProductStorageConditionGridControl : BOSComponent.BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            CompanyConstantEntities entity = (CompanyConstantEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            BindingSource bds = new BindingSource();
            bds.DataSource = entity.ProductStorageConditionList;
            this.DataSource = bds;            
        }
            ...
            if (e.Value != null)
            {
                if (gridView.FocusedColumn.FieldName == "ADConfigText")
                {
                    ...
                    else
                    {
                        ...
                        {
                            ((CompanyConstantModule)Screen.Module).CheckConfigValues(e.Value.ToString().Trim(), e, ConfigValueGroup.ProductStorageCondition.ToString());
                        }
                    }
                }
            }
        ...
        protected override void GridView_KeyUp(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            ...
            {
                ((CompanyConstantModule)Screen.Module).RemoveSelectedProductStorageCondition();
            }
        }
    }
}
