...
{
    public partial class ADInsurrancePlansGridControl : BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            CompanyConstantEntities entity = (CompanyConstantEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            BindingSource bds = new BindingSource();
            bds.DataSource = entity.InsurrancePlansList;
            this.DataSource = bds;
        }
        ...
        protected override GridView InitializeGridView()
        {
            ...
            GridColumn column = gridView.Columns["ADInsurrancePlanNo"];
            if (column != null)
            {
                column.OptionsColumn.AllowEdit = true;
            }

            column = gridView.Columns["ADInsurrancePlanName"];
            if (column != null)
            {
                column.OptionsColumn.AllowEdit = true;
            }

            column = gridView.Columns["ADInsurrancePlanIsUnCheckBHXH"];
            if (column != null)
            {
                column.OptionsColumn.AllowEdit = true;
            }

            column = gridView.Columns["ADInsurrancePlanSocialID"];
            if (column != null)
            {
                column.OptionsColumn.AllowEdit = true;
        ...
        private void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                ((CompanyConstantModule)Screen.Module).RemoveSelectedInsurrancePlans();
            }
        }
    }
}
