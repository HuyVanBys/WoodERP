...
{
    public partial class MInvoice_EInvoiceConfigsGridControl : BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            EInvoiceConfigEntities entity = (EInvoiceConfigEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            BindingSource bds = new BindingSource();
            bds.DataSource = entity.MInvoiceEInvoiceConfigsList;
            this.DataSource = bds;
        }
        ...
        protected override void AddColumnsToGridView(string strTableName, DevExpress.XtraGrid.Views.Grid.GridView gridView)
        {
            ...
            newColumn.Caption = "Tài khoản MInvoice";
            newColumn.FieldName = "ACEInvoiceConfigAccount";
            newColumn.OptionsColumn.AllowEdit = true;
            newColumn.Visible = true;
            ...
            newColumn.FieldName = "ACEInvoiceConfigACpass";
            newColumn.OptionsColumn.AllowEdit = true;
            newColumn.Visible = true;
            ...
            newColumn = new GridColumn();
            newColumn.Caption = "Mã số thuế";
            newColumn.FieldName = "ACEInvoiceConfigTaxNumber";
            newColumn.OptionsColumn.AllowEdit = true;
            newColumn.Visible = true;
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Delete)
            {
                ...
                {
                    ((EInvoiceConfigModule)Screen.Module).RemoveSelectedEInvoiceConfigsListMInvoice();
                }
            }
        }
        ...
        protected override void GridView_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            ...
            {
                objEInvoiceConfigsInfo.ACEInvoiceConfigPartnerType = EInvoiceConfigPartnerType.MInvoice.ToString();
                ACTaxUnitsController objTaxUnitsController = new ACTaxUnitsController();
                List<ACTaxUnitsInfo> listTaxUnitsInfo = objTaxUnitsController.GetAllACTaxUnits();
