...
{
    public partial class RP138 : ReportForm
    {
        /// <summary>
        ...
        private void RP137_Load(object sender, EventArgs e)
        {
            ...
            List<ACAssetsInfo> AssetList = objReportsController.GetAssetForReport();
            fld_dgcRP138ACAssets.DataSource = AssetList;
        }
        ...
        private void fld_btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    fld_dgcRP138ACAssets.ExportToXlsx(fileName);
                }
            }
            catch (Exception ex)
            {
