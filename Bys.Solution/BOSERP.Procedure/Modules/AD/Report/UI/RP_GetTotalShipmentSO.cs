...
{
    public partial class RP_GetTotalShipmentSO : ReportForm
    {
        /// <summary>
        /// Define location id
        /// </summary>
        ...
        /// </summary>
        private List<MMBatchProductItemsInfo> ReportDataSource = new List<MMBatchProductItemsInfo>();
        ...
        public void InitDataSource()
        {
            ...
            string saleType = Convert.ToString(fld_lkeFK_MMSaleOrderSaleType.EditValue);
            ADReportsController objReportsController = new ADReportsController();
            List<MMBatchProductItemsInfo> batchProductsList = new List<MMBatchProductItemsInfo>();
            batchProductsList = objReportsController.GetTotalShipmentSO(dateFrom,
                                                                          dateTo,
                                                                          workshopID,
                                                                          saleType);
            fld_dgcRPGetTotalShipmentSO.DataSource = batchProductsList;
            ReportDataSource = batchProductsList;
            if (batchProductsList.Count == 0)
        ...
        {
            BOSReport.RP_GetTotalShipmentSO rp = new BOSReport.RP_GetTotalShipmentSO();
        ...
        private void fld_btnExportExcelXls_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    fld_dgcRPGetTotalShipmentSO.ExportToXlsx(fileName);
                }
            }
            catch (Exception ex)
            {
