...
{
    public partial class RP120 : ReportForm
    {
        ...
        private void fld_btnPrint_Click(object sender, EventArgs e)
        {
            ...
            List<MMBatchProductProductionNormItemsInfo> resultList = objBPPNIsController.GetItemForReportBTPSon(customerID, batchProductID, dateFrom, dateTo);
            fld_dgcRP120BatchProductProductionNormItems.DataSource = resultList;
