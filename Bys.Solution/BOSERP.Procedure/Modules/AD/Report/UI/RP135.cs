...
{
    public partial class RP135 : ReportForm
    {
        /// <summary>
        ...
        private void fld_btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    fld_dgcRP135PurchaseOrder.ExportToXlsx(fileName);
                }
            }
            catch (Exception ex)
            {
        ...
        public void GetDataSearch()
        {
            ...
            List<APPurchaseOrderItemsInfo> PurchaseOrderItemList = objReportsController.GetPurchaseOrderForReportBySupplierID(supplierID, productID, searchFromDate, searchToDate);
            fld_dgcRP135PurchaseOrder.DataSource = PurchaseOrderItemList;
