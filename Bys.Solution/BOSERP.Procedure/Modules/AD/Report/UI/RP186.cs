...
{
    public partial class RP186 : ReportForm
    {
        ...
        {
            BOSReport.RP186 report = new BOSReport.RP186();
        ...
        public bool InitDataSourceReport(XtraReport report)
        {
            ...
            else
            {
                ...
                List<ARInvoiceItemsInfo> InvoiceItemList = objInvoiceItemsController.GetDataForReport186(dateFrom, dateTo, invoiceVATNo);
