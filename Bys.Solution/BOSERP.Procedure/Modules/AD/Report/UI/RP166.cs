...
{
    public partial class RP166 : ReportForm
    {
        /// <summary>
        ...
        private void fld_btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    fld_dgcRP166ICreceiptItems.ExportToXlsx(fileName);
                }
            }
            catch (Exception ex)
            {
        ...
        public void GetDataSearch()
        {
            ...
            ReceiptItemList = objReportsController.GetReceiptItemForReportFromOperation166(searchFromDate, searchToDate, batchProductID, productID);
            fld_dgcRP166ICreceiptItems.DataSource = ReceiptItemList;
