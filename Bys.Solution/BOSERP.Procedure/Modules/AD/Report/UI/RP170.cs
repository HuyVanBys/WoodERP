...
{
    public partial class RP170 : ReportForm
    {
        /// <summary>
        ...
        private void fld_btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    fld_dgcRP170ICreceiptItems.ExportToXlsx(fileName);
                }
            }
            catch (Exception ex)
            {
        ...
        public void GetDataSearch()
        {
            ...
            ReceiptItemList = objReportsController.GetReceiptItemForReportFromOperation170(searchFromDate, searchToDate, batchProductID, productID);
            fld_dgcRP170ICreceiptItems.DataSource = ReceiptItemList;
