...
{
    public partial class RP169 : ReportForm
    {
        /// <summary>
        ...
        private void fld_btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    fld_dgcRP169ICreceiptItems.ExportToXlsx(fileName);
                }
            }
            catch (Exception ex)
            {
        ...
        public void GetDataSearch()
        {
            ...
            ReceiptItemList = objReportsController.GetReceiptItemForReportFromOperation169(searchFromDate, searchToDate, batchProductID, productID);
            fld_dgcRP169ICreceiptItems.DataSource = ReceiptItemList;
