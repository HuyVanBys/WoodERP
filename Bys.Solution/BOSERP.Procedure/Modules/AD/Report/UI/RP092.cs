...
{
    public partial class RP092 : ReportForm
    {
        /// <summary>
        /// Define location id
        /// </summary>
        ...
        public void InitDataSource()
        {
            ...
            if (SelectedEmployeeList.Count > 0)
            {
                foreach (HREmployeesInfo objEmployeesInfo in SelectedEmployeeList)
                {
                    ...
                    //List<ARInvoiceItemsInfo> result = objReportsController.GetInvoiceItemsListBySaleOrder(
                    //                                                                    locationID,
                    //                                                                    branchID,
                    //                                                                    customerID,
                    //                                                                    productID,
                    ...
                    {
                        result = objReportsController.GetInvoiceItemsListBySaleOrder(
                                                                                    null,
                                                                                    branch.BRBranchID,
                                                                                    objectID,
                                                                                    objectType,
            ...
            {
                //NUThao [EDIT] [10/16/2014] [DB centre] [Report Permission], START
                //invoiceItemList = objReportsController.GetInvoiceItemsListBySaleOrder(
                //                                                        locationID,
                //                                                        branchID,
                //                                                        customerID,
                //                                                        productID,
        ...
        private void fld_btnPrint_Click(object sender, EventArgs e)
        {
            ...
            if (title != null)
            {
                title.Text = "Danh sách hóa đơn theo đơn hàng";
                if (branchID > 0)
