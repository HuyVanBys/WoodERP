...
{
    public partial class RP046 : ReportForm
    {
        /// <summary>
        ...
        private void fld_btnPrint_Click(object sender, EventArgs e)
        {
            ...
            string stringReportTitle = "TỔNG HỢP CÔNG NỢ PHẢI TRẢ";
            ...
            //report.LoadLayout("Reports\\RP046Currencys.repx");
            //guiReportDesigner designer = new guiReportDesigner(report, "Reports\\RP046Currencys.repx");
            //designer.Show();
        }
        ...
        public void InitAccounts()
        {
            ...
            fld_dgcACRP046Accounts.DataSource = AccountList;
        }
        ...
        private void RP046_Load(object sender, EventArgs e)
        {
        ...
        private void fld_chkSellectAllAccount_CheckedChanged(object sender, EventArgs e)
        {
            ...
            fld_dgcACRP046Accounts.RefreshDataSource();
        }
        ...
        private void fld_btnView_Click(object sender, EventArgs e)
        {
            ...
            DateTime dateTo = fld_dteSearchToDate.DateTime;
            int branchID = Convert.ToInt32(fld_lkeBRBranchID.EditValue);
            BOSList<ACDocumentEntrysInfo> entries = InitDataViewRP046();
            if (entries != null && entries.Count > 0)
            {
                ...
                if (currencyID > 0)
                {
                    if (currencyID == GECurrencyID.VND)
                    {
                        guiRP049Show gui = new guiRP049Show(entries, dateFrom, dateTo, selectedAccounts, currencyID, branchID, "RP046");
                        gui.Module = Module;
                        gui.ShowDialog();
                    }
                    else
                    {
                        guiRP049CurrencyShow gui = new guiRP049CurrencyShow(entries, dateFrom, dateTo, selectedAccounts, currencyID, branchID, "RP046");
                        gui.Module = Module;
                        gui.ShowDialog();
                    }
                }
        ...
        public BOSList<ACDocumentEntrysInfo> InitDataViewRP046()
        {
            DateTime dateFrom = fld_dteSearchFromDate.DateTime;
            DateTime dateTo = fld_dteSearchToDate.DateTime;
            BRBranchsController objBranchsController = new BRBranchsController();
