...
{
    public partial class RP042ACDocumentEntrysGridControl : ReportGridControl
    {
        ...
        private BandedGridView InitializeBandedGridView(GridView gridView)
        {
            ...
            GridBand gridBand5 = CreateGridBand("gridBand5", "Số phát sinh");
            GridBand gridBand6 = CreateGridBand("gridBand6", "Số dư");
            ...
            foreach (GridColumn column in gridView.Columns)
            {
                ...
                if (column != null && ((column.FieldName == "AccountDebitBalance")))
                {
                    BandedGridColumn bandedColumn = ConvertToBandedColumn(column, true);
                    InitColumnRepositoryText(bandedColumn, "n2");
                ...
                if (column != null && ((column.FieldName == "AccountCreditBalance")))
                {
                    BandedGridColumn bandedColumn = ConvertToBandedColumn(column, true);
                    InitColumnRepositoryText(bandedColumn, "n2");
                    bandedColumn.OwnerBand = gridBand6;
