...
{
    public partial class RP049DetailCurrencyACDocumentEntrysGridControl : ReportGridControl
    {
        ...
        protected override void AddColumnsToGridView(string strTableName, DevExpress.XtraGrid.Views.Grid.GridView gridView)
        {
            ...
            column.Caption = "Tiền tệ";
            column.OptionsColumn.AllowEdit = false;
            column.Visible = true;
            gridView.Columns.Add(column);

            column = new GridColumn();
            column.FieldName = "ACDocumentExchangeRate";
            ...
            .All(o =>
            {
                gridView.Columns.Add(CreateGridColumn(o.ToString(), "Nợ NT", false));
                return true;
            });
            new DocumentEntrysColumnName[]
            {
            ...
            .All(o =>
            {
                gridView.Columns.Add(CreateGridColumn(o.ToString(), "Nợ VND", false));
                return true;
            });
            new DocumentEntrysColumnName[]
            {
            ...
            .All(o =>
            {
                gridView.Columns.Add(CreateGridColumn(o.ToString(), "Có NT", false));
                return true;
            });
            new DocumentEntrysColumnName[]
            {
            ...
            .All(o =>
            {
                gridView.Columns.Add(CreateGridColumn(o.ToString(), "Có VND", false));
                return true;
            });
            new DocumentEntrysColumnName[]
            {
        ...
        private BandedGridView InitializeBandedGridView(GridView gridView)
        {
            ...
            GridBand gridBand6 = CreateGridBand("gridBand6", string.Empty);
            GridBand gridBand7 = CreateGridBand("gridBand7", string.Empty);
            GridBand gridBand8 = CreateGridBand("gridBand8", "Số phát sinh");
            ...
            foreach (GridColumn column in gridView.Columns)
            {
                ...
                if (column != null && (column.FieldName == "ACDocumentExchangeRate"))
                {
                    BandedGridColumn bandedColumn = ConvertToBandedColumn(column, true);
