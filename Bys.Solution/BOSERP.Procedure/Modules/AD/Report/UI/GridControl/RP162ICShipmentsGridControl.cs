...
{
    public class RP162ICShipmentsGridControl : BOSGridControl
    {
        ...
        protected override void AddColumnsToGridView(string strTableName, DevExpress.XtraGrid.Views.Grid.GridView gridView)
        {
            ...
            column = new GridColumn();
            column.FieldName = "ThanhTienThucTeXuat";
            column.Caption = "Thành tiền thực tế xuất";
            column.OptionsColumn.AllowEdit = false;
            column.Visible = true;
            ...
            column = new GridColumn();
            column.FieldName = "GiaTriTraVe";
            column.Caption = "Giá trị gỗ trả về";
            column.OptionsColumn.AllowEdit = false;
            column.Visible = true;
            ...
            column = new GridColumn();
            column.FieldName = "TongGiaTriThucTeXuat";
            column.Caption = "Tổng giá trị thực tế";
            column.OptionsColumn.AllowEdit = false;
            column.Visible = true;
        ...
        void gridView_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (gridView.FocusedColumn != null)
            {
                if (gridView.FocusedRowHandle >= 0)
                {
                    ...
                    if (item != null)
                    {
                        (((RP162)Screen)).GetAllData(item.BatchProductID, item.ICShipmentItemHeight, item.FK_ICProductAttributeWoodTypeID);
                    }
                }
            }
        }
