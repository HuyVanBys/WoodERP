...
{
    public partial class RP245 : ReportForm
    {
        /// <summary>
        /// Define location id
        /// </summary>
        ...
        public void InitDataSource()
        {
            ...
            shipmentItemsList = objReportsController.GetShipmentByBatchProduct(dateFrom,
                                                                          dateTo,
                                                                          deparmentID,
                                                                          productGroupID);
            fld_dgcARRP245ICShipmentItems.DataSource = shipmentItemsList;
            fld_dgcARRP245ICShipmentItems.DataSource = shipmentItemsList;
        ...
        {
            BOSReport.RP245 rp = new BOSReport.RP245();
            ReportDataSource = ReportDataSource.GroupBy(o => new
            {
                o.MMBatchProductItemSOName,
                o.MMBatchProductNo,
                o.ACObjectName,
                o.ICProductName
            }).Select(o => new ICShipmentItemsInfo()
            {
                MMBatchProductItemSOName = o.Key.MMBatchProductItemSOName,
                MMBatchProductNo = o.Key.MMBatchProductNo,
                ACObjectName = o.Key.ACObjectName,
                ICProductName = o.Key.ICProductName,
                ICShipmentItemProductQty = o.Sum(s => s.ICShipmentItemProductQty),
                ICReceiptItemProductQty = o.Sum(s => s.ICReceiptItemProductQty),
                TotalQty = o.Sum(s => s.ICShipmentItemProductQty) - o.Sum(s => s.ICReceiptItemProductQty)
            }).OrderBy(o => o.ICProductName).ToList();
        ...
        private void fld_btnExportExcelXls_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    fld_dgcARRP245ICShipmentItems.ExportToXlsx(fileName);
                }
            }
            catch (Exception ex)
            {
