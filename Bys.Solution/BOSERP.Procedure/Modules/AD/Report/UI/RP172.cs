...
{
    public partial class RP172 : ReportForm
    {
        /// <summary>
        ...
        private void fld_btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    fld_dgcRP172ICreceiptItems.ExportToXlsx(fileName);
                }
            }
            catch (Exception ex)
            {
        ...
        public void GetDataSearch()
        {
            ...
            ReceiptItemList = objReportsController.GetReceiptItemForReportFromOperation172(searchFromDate, searchToDate, batchProductID, productID);
            fld_dgcRP172ICreceiptItems.DataSource = ReceiptItemList;
