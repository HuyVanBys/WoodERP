...
{
    public partial class RP049I : ReportForm
    {
        /// <summary>
        ...
        private void RP049_Load(object sender, EventArgs e)
        {
            ...
            fld_lkeObjectType.EditValue = ObjectType.Customer.ToString();
        ...
        private void fld_btnPrint_Click(object sender, EventArgs e)
        {
            ...
            if (currencyID > 0)
            {
                report = new BOSReport.RP049();
                InitDataSourceForReportAllCurrency(report);
            }
            else
            {
                report = new BOSReport.RP049Currencys();
                InitDataSourceForReportAllCurrency(report);
            }
        ...
        public void InitDataSourceForReportAllCurrency(XtraReport report)
        {
            ...
            {
                documentEntrys = documentEntrys.Concat(objDocumentEntrysController.GetDocumentEntrysForReportRP049I(fromDate, toDate, currencyID, objectType, objectID, reportType, branchID, objAccountsInfo.ACAccountID)).ToList();
            }
        ...
        //    int locationID = Convert.ToInt32(fld_lkeGELocationID.EditValue);
        //    int branchID = Convert.ToInt32(fld_lkeBRBranchID.EditValue);
        //    ////NHAnh [ADD][05/05/2017][branchName],Start
        //    //string BranchName = string.Empty;
        //    //if (branchID == 0)
        //    //{
        //    //    List<BRBranchsInfo> branchList = objBranchsController.GetAllBranches();
        //    //    foreach (BRBranchsInfo item in branchList)
        //    //    {
        //    //        if (!string.IsNullOrEmpty(BranchName))
        //    //        {
        //    //            BranchName += ", \r";
        //    //        }
        //    //        BranchName += item.BRBranchName;
        //    //    }
        //    //}
        //    //else
        //    //{
        //    //    BRBranchsInfo branch = (BRBranchsInfo)objBranchsController.GetObjectByID(branchID);
        //    //    if (branch != null)
        //    //    {
        //    //        BranchName = branch.BRBranchName;
        //    //    }
        //    //}
        //    //XRLabel branchName = (XRLabel)report.Bands[BandKind.GroupHeader].Controls["xr_lblBranchName"];
        //    //if (branchName != null)
        //    //    branchName.Text = "Chi nhánh: " + BranchName;
        //    ////NHAnh [ADD][05/05/2017][branchName],End
        ...
        //    //List<ACObjectsInfo> objects = GetObjectList(selectedBranches);
        ...
        //            decimal endBalanceVND = Math.Round(startBalanceVND + entry.TransactionDebitAccountVND - entry.TransactionCreditAccountVND, 3);
        //            if (endBalanceVND < 0)
        //            {
        ...
        //            decimal endBalanceUSD = Math.Round(startBalanceUSD + entry.TransactionDebitAccountUSD - entry.TransactionCreditAccountUSD, 3);
        //            decimal baseEndBalanceUSD = Math.Round(baseOpenBalancetUSD + entry.TransactionDebitAccountVND4USD - entry.TransactionCreditAccountVND4USD, 3);
        //            if (endBalanceUSD < 0)
        ...
        //            decimal endBalanceEURO = Math.Round(startBalanceEURO + entry.TransactionDebitAccountEURO - entry.TransactionCreditAccountEURO, 3);
        //            decimal endBalanceVND4EURO = Math.Round(baseOpenBalanceEURO + entry.TransactionDebitAccountVND4EURO - entry.TransactionCreditAccountVND4EURO, 3);
        //            if (endBalanceEURO < 0)
        ...
        //            decimal endBalanceRMB = Math.Round(startBalanceRMB + entry.TransactionDebitAccountRMB - entry.TransactionCreditAccountRMB, 3);
        //            decimal endBalanceVND4RMB = Math.Round(baseOpenBalanceRMB + entry.TransactionDebitAccountVND4RMB - entry.TransactionCreditAccountVND4RMB, 3);
        //            if (endBalanceRMB < 0)
        ...
        //            decimal endBalanceSGD = Math.Round(startBalanceSGD + entry.TransactionDebitAccountSGD - entry.TransactionCreditAccountSGD, 3);
        //            decimal endBalanceVND4SGD = Math.Round(baseOpenBalanceSGD + entry.TransactionDebitAccountVND4SGD - entry.TransactionCreditAccountVND4SGD, 3);
        //            if (endBalanceSGD < 0)
        ...
        //            decimal endBalanceGBP = Math.Round(startBalanceGBP + entry.TransactionDebitAccountGBP - entry.TransactionCreditAccountGBP, 3);
        //            decimal endBalanceVND4GBP = Math.Round(baseOpenBalanceGBP + entry.TransactionDebitAccountVND4GBP - entry.TransactionCreditAccountVND4GBP, 3);
        //            if (endBalanceGBP < 0)
        ...
        //            entry.ACObjectNo = obj.ACObjectNo;
        //            entry.ACObjectName = obj.ACObjectName;
        //            BOSProgressBar.Start(obj.ACObjectName);
        //            entry.ACDocumentEntryAccountNo = objAccountsInfo.ACAccountNo;
        //            entry.ACDocumentEntryAccountNoDisplayText = accountNoAndName;
        //            entry.GECurrencyName = currencyName;
        ...
        //            decimal endBalance = startBalance + entry.ACDocumentEntryDebitAmount - entry.ACDocumentEntryCreditAmount;
        //            if (currencyID > 0)
        //            {
        ...
        //                endBalance = Math.Round(endBalance, currency.GECurrencyDecimalNumber);
        //            }
        //            else
        //            {
        //                endBalance = Math.Round(endBalance, 3);
        //            }
        //            if (endBalance > 0)
        //            {
        ...
        private List<ACObjectsInfo> GetObjectList(List<BRBranchsInfo> selectedBranches)
        {
            ACObjectsController objObjectsController = new ACObjectsController();
            List<ACObjectsInfo> objects = new List<ACObjectsInfo>();
            string objectAccessKey = Convert.ToString(fld_lkeACObjectID.EditValue);
            ...
            else
            {
                ...
                foreach (ACAccountsInfo account in selectedAccounts)
                {
                    ...
                    result = new List<ACDocumentEntrysInfo>();
                    foreach (BRBranchsInfo branch in selectedBranches)
                    {
                        List<ACDocumentEntrysInfo> lst = objDocumentEntrysController.GetEntriesByAccountID(
                                                                           account.ACAccountID,
                                                                           null,
                                                                           objectType,
                                                                           null,
