...
{
    public partial class RP042 : ReportForm
    {
        /// <summary>
        ...
        private void fld_btnPrint_Click(object sender, EventArgs e)
        {
            ...
            if (currencyID > 0)
            {
                if (currencyID == 100000)
                    report = new BOSReport.RP042VND();
                else
                    report = new BOSReport.RP042();
            }
            else
            {
                report = new BOSReport.RP042Currency();
            }
        ...
        private void RP042_Load(object sender, EventArgs e)
        {
            ...
            AccountList = objAccountsController.GetDetailAccounts();
            fld_dgcACRP042Accounts.DataSource = AccountList;
            //fld_dgcACRP042Accounts.DataSource = AccountList.Where( x => x.ACAccountType != "DebitCreditBalance").ToList();
        }
        ...
        private void fld_chkSellectAllAccount_CheckedChanged(object sender, EventArgs e)
        {
            ...
            fld_dgcACRP042Accounts.RefreshDataSource();
        }
    }
}
