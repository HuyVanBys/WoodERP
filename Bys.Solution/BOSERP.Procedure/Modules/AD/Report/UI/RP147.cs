...
{
    public partial class RP147 : ReportForm
    {
        ...
        private void fld_btnPrint_Click(object sender, EventArgs e)
        {
            ...
            List<MMBatchProductItemsInfo> resultList = objBatchProductItemsController.GetBatchProductItemsForReport147(customerID, batchProductID, dateFrom, dateTo);
            fld_dgcRP147BatchProductItems.DataSource = resultList;
        }
