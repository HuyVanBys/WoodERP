...
{
    public partial class RP050 : ReportForm
    {
        /// <summary>
        ...
        public void InitAccounts()
        {
            ...
            fld_dgcACRP050Accounts.DataSource = AccountList;
        }
        ...
        public bool InitDataSourceReport(XtraReport report)
        {
            ...
            if (xrTitle != null)
                xrTitle.Text = "SỔ CHI TIẾT CÔNG NỢ PHẢI THU";
        ...
        private void RP050_Load(object sender, EventArgs e)
        {
        ...
        private void fld_chkSellectAllAccount_CheckedChanged(object sender, EventArgs e)
        {
            ...
            fld_dgcACRP050Accounts.RefreshDataSource();
        }
        ...
        private void fld_btnView_Click(object sender, EventArgs e)
        {
            ...
            if (entries != null && entries.Any())
            {
                if (currencyID == GECurrencyID.VND)
                {
                    guiRP049ShowDetail gui = new guiRP049ShowDetail(entries, dateFrom, dateTo, currencyName, selectedObject.ACObjectName, "RP050");
                    gui.Module = Module;
                    gui.ShowDialog();
                }
                else
                {
                    guiRP049CurrencyShowDetail gui = new guiRP049CurrencyShowDetail(entries, dateFrom, dateTo, currencyName, selectedObject.ACObjectName, "RP050");
                    gui.Module = Module;
                    gui.ShowDialog();
                }
            }
