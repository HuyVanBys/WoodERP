...
{
    public partial class RP184 : ReportForm
    {
        ...
        {
            BOSReport.RP184 report = new BOSReport.RP184();
        ...
        public bool InitDataSourceReport(XtraReport report)
        {
            ...
            else
            {
                ...
                List<ARInvoiceItemsInfo> InvoiceItemList = objInvoiceItemsController.GetDataForReport184(dateFrom, dateTo, invoiceVATNo);
