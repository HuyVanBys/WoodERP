...
{
    public partial class RP094 : ReportForm
    {
        /// <summary>
        ...
        private void fld_btnPrint_Click(object sender, EventArgs e)
        {
            ...
            if (columnHeaders != null && columnHeaders.Count != 0)
            {
                ...
                if (form != null)
                {
                    ...
                    form.FormHeader = "Khấu hao tài sản cố định";
                    form.FormTitle = "Bảng tổng hợp khấu hao tài sản cố định";
                    if (columnHeaders.Count > 1)
                        form.SubTitle = "Từ " + columnHeaders[0] + " đến " + columnHeaders[columnHeaders.Count - 1];
                    else
                        form.SubTitle = "Tháng " + columnHeaders[0];
                    form.Show();
                }
            }
        ...
        private DataTable CreateDataTable(List<string> columnHeaders)
        {
            ...
            dt.Columns.Add(new DataColumn("ACAssetOriginalAmount", typeof(double)));
            dt.Columns.Add(new DataColumn("AssetOpenRemainedAmount", typeof(double)));
     
            
            foreach (string columnHeader in columnHeaders)
            {
                dt.Columns.Add(new DataColumn(columnHeader, typeof(double)));
            }

            dt.Columns.Add(new DataColumn("AssetTransactionDepreciatedAmount", typeof(double)));
            dt.Columns.Add(new DataColumn("AssetEndRemainedAmount", typeof(double)));
            ...
            {                                
                ...
                if (depreciationEntries != null && depreciationEntries.Count != 0)
                {
                    ...
                    if (asset.AssetOpenRemainedAmount != 0)
                    {
                        ...
                        double transactionDepreciatedAmountForEachMonth = 0;
                        SortedList<string, double> depreciationAmounts = new SortedList<string, double>();
        ...
        public BandedGridView InitBandedGridView(DevExpress.XtraGrid.Views.Grid.GridView gridView, List<string> columnHeaders)
        {
            ...
            bandedUserGroupSectionColumn.Caption = "Mã tài sản";
            ...
            bandedUserGroupSectionColumn.Caption = "Tên tài sản";
            ...
            bandedUserGroupSectionColumn.Caption = "Số thẻ";
            ...
            bandedUserGroupSectionColumn.Caption = "Tài khoản";
            ...
            bandedUserGroupSectionColumn.Caption = "Ngày sử dụng";
            ...
            bandedUserGroupSectionColumn.Caption = "TG khấu hao";
            ...
            bandedUserGroupSectionColumn.Caption = "Nguyên giá";
            ...
            bandedUserGroupSectionColumn.Caption = "Đầu kỳ còn lại";
            ...
            itemGridBand1.Caption = "Lượng khấu hao";
            ...
            AssetTransactionDepreciatedAmountColumn.Caption = "Tổng số";
            ...
            AssetEndRemainedAmountColumn.Caption = "Cuối kỳ còn lại";
        ...
        private void Reloadassets()
        {
            ...
            {
                AssetList = objAssetsController.GetAssetsBySomeCriteria(fromDate, toDate, assetType, branchID, roomID);
                fld_dgcRP063Assets.DataSource = AssetList;
            }
        }
