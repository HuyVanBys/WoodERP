...
{
    public partial class RP168 : ReportForm
    {
        /// <summary>
        ...
        private void fld_btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    fld_dgcRP168ICreceiptItems.ExportToXlsx(fileName);
                }
            }
            catch (Exception ex)
            {
        ...
        public void GetDataSearch()
        {
            ...
            ReceiptItemList = objReportsController.GetReceiptItemForReportFromOperation168(searchFromDate, searchToDate, batchProductID, productID);
            fld_dgcRP168ICreceiptItems.DataSource = ReceiptItemList;
