...
{
    public partial class RP130 : ReportForm
    {
        /// <summary>
        ...
        private void RP130_Load(object sender, EventArgs e)
        {
        ...
        private void fld_btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    fld_dgcRP130PurchaseOrderItems.ExportToXlsx(fileName);
                }
            }
            catch (Exception ex)
            {
        ...
        public void GetDataSearch()
        {
            ...
            if (fld_lkeICProductID.EditValue != null)
                int.TryParse(fld_lkeICProductID.EditValue.ToString(), out objectID);
            if (fld_lkeICProductID2.EditValue != null)
                int.TryParse(fld_lkeICProductID2.EditValue.ToString(), out objectID1);
            DateTime searchFromDate = fld_dteSearchFromDate.DateTime;
            DateTime searchToDate = fld_dteSearchToDate.DateTime;
            ADReportsController objReportsController = new ADReportsController();
            List<APPurchaseOrderItemsInfo> purchaseOrderItemList = objReportsController.GetPurchaseOrderItemByProductID(objectID, objectID1, searchFromDate, searchToDate);
            fld_dgcRP130PurchaseOrderItems.DataSource = purchaseOrderItemList;
