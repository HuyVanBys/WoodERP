...
{
    public partial class RP051 : ReportForm
    {
        /// <summary>
        ...
        #region Events
        private void RP051_Load(object sender, EventArgs e)
        {
            ...
            fld_dgcICRP051Products.DataSource = SelectedProductList;
        ...
        private void fld_btnPrint_Click(object sender, EventArgs e)
        {
            ...
            if (stockID != -2)
            {
                report = new BOSReport.RP051();
            }
            else
            {
                report = new BOSReport.RP080();
            }
        ...
        private void fld_chkSelectAll_CheckedChanged(object sender, EventArgs e)
        {
            ...
            fld_dgcICRP051Products.RefreshDataSource();
        }
        #endregion
        ...
        private List<ICReceiptItemsInfo> GetStockCardListBySomeCriteria()
        {
            ...
            ICInvBalancesController ICInvBalancesController = new ICInvBalancesController();
            ...
            List<ICInvBalancesInfo> initInventoryStocks = new List<ICInvBalancesInfo>();
            List<ICProductsInfo> selectedProduct = SelectedProductList.Where(product => product.Selected).ToList();
            foreach (ICProductsInfo product in selectedProduct)
            {
                //NUThao [EDIT] [10/16/2014] [DB centre] [Report Permission], START
                ...
                List<ICInvBalancesInfo> temp1 = ICInvBalancesController.GetInvBalancesForBeginningBySomeConditions(product.ICProductID, stockNoList, null, null);
                initInventoryStocks = initInventoryStocks.Concat(temp1).ToList();
                //NUThao [EDIT] [10/16/2014] [DB centre] [Report Permission], END
            }
            ...
            foreach (ICStocksInfo stock in stocks)
            {
                foreach (ICProductsInfo objProductsInfo in selectedProduct)
                {
