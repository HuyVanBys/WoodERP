...
namespace BOSERP.Modules.Report
{
    public partial class RP164 : ReportForm
    {
        ...
        private void fld_btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    fld_dgcRP164ARInvoiceItems.ExportToXlsx(fileName);
                }
            }
            catch (Exception ex)
            {
        ...
        public void GetDataSearch()
        {
            ...
            int customerID = 0;
            int InvoiceID = 0;
            int.TryParse(fld_lkeARInvoiceID.EditValue.ToString(), out InvoiceID);
            ...
            InvoiceItemList = objReportsController.GetListItemForReport163(searchFromDate, searchToDate, InvoiceID, customerID);
            fld_dgcRP164ARInvoiceItems.DataSource = InvoiceItemList;
