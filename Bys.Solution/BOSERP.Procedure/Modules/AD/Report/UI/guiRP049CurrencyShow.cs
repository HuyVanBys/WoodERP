...
{
    public partial class guiRP049CurrencyShow : BOSERPScreen
    {
        ...
        string Type;
        public guiRP049CurrencyShow(BOSList<ACDocumentEntrysInfo> documentEntrys, DateTime fromDate, DateTime toDate, List<ACAccountsInfo> selectedAccounts, int currencyID, int branchID, string type)
        {
        ...
        {
            fld_dgcRP049CurrencyACDocumentEntrys.DataSource = DocumentEntryList;
            fld_dgcRP049CurrencyACDocumentEntrys.RefreshDataSource();
        }
        ...
        private void fld_dgcRP049CurrencyACDocumentEntrys_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (entry != null)
            {
                ...
                {
                    guiRP049CurrencyShowDetail gui = new guiRP049CurrencyShowDetail(entries, FromDate, ToDate, entry.GECurrencyName, entry.ACObjectName, Type);
                    gui.Module = Module;
                    gui.ShowDialog();
                }
                else
        ...
        private void fld_btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    fld_dgcRP049CurrencyACDocumentEntrys.ExportToXlsx(fileName);
                }
            }
            catch (Exception ex)
            {
