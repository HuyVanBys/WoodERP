...
{
    public partial class guiRP049ShowDetail : BOSERPScreen
    {
        public List<ACDocumentEntrysInfo> DocumentEntryList { get; set; }
        public DateTime FromDate, ToDate;
        public guiRP049ShowDetail(List<ACDocumentEntrysInfo> documentEntrys, DateTime fromDate, DateTime toDate, string currencyName, string objectName, string type)
        {
            ...
            this.label_GECurrencyName.Text += currencyName;
        ...
        {
            fld_dgcRP049DetailACDocumentEntrys.DataSource = DocumentEntryList;
            fld_dgcRP049DetailACDocumentEntrys.RefreshDataSource();
        }
        ...
        private void fld_btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    fld_dgcRP049DetailACDocumentEntrys.ExportToXlsx(fileName);
                }
            }
            catch (Exception ex)
            {
