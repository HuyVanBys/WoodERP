...
{
    public partial class RP116 : ReportForm
    {
        ...
        private void fld_btnPrint_Click(object sender, EventArgs e)
        {
            ...
            List<MMBatchProductProductionNormItemsInfo> resultList = objBPPNIsController.GetItemForReportBTPPhoi(customerID, batchProductID, dateFrom, dateTo);
            fld_dgcRP116BatchProductProductionNormItems.DataSource = resultList;
