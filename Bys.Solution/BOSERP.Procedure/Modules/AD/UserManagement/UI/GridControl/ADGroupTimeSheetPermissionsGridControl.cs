...
{
    public partial class ADGroupTimeSheetPermissionsGridControl : BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            UserManagementEntities entity = (UserManagementEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            BindingSource bds = new BindingSource();
            bds.DataSource = entity.GroupTimeSheetPermissionList;
            DataSource = bds;
        }
        ...
        protected override void AddColumnsToGridView(string strTableName, GridView gridView)
        {
            ...
            column.Caption = UserManagementLocalizedResources.HREmployeePayrollFormulaName;
