...
{
    public class GENumberingGridControl : BOSComponent.BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            ...
            DataSet ds = new GENumberingController().GetAllObjects();
            entity.GENumberingsList.Invalidate(ds);
        }
        ...
        protected override void GridView_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e)
        {
            ...
            try
            {
                ...
                if (isError)
                {
                    MessageBox.Show(String.Format("Number must be less than {0}", iMaxValue), "#Message#", MessageBoxButtons.OK, MessageBoxIcon.Error);
