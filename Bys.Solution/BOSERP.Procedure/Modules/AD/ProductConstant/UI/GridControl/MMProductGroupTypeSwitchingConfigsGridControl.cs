...
{
    public partial class MMProductGroupTypeSwitchingConfigsGridControl : BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            ProductConstantEntities entity = (ProductConstantEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            BindingSource bds = new BindingSource();
            bds.DataSource = entity.ProductGroupTypeSwitchingConfigList;
            this.DataSource = bds;
        }
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                ((ProductConstantModule)Screen.Module).RemoveSelectedProductGroupTypeSwitchingConfigList();
            }
        }
